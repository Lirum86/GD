...
local function ConditionalBoosts(arg1, arg2) -- Line 480
	--[[ Upvalues[1]:
		[1]: ReplicatedStorage_upvr (readonly)
	]]
	if ReplicatedStorage_upvr.world.weather.Value == "Rain" then
		return {
			Luck = arg1.Luck * 2;
			Lure = arg1.Lure * 2;
			Mutations = {{
				Name = arg1.Mutations[1].Name;
				Chance = arg1.Mutations[1].Chance * 2;
			}};
		}
	end
end
tbl_3.ConditionalBoosts = ConditionalBoosts
tbl_3.RelicGroup = "Default"
tbl_5.Storming = tbl_3
tbl_5.Scrapper = {
...
local function ConditionalBoosts(arg1, arg2) -- Line 519
	--[[ Upvalues[1]:
		[1]: ReplicatedStorage_upvr (readonly)
	]]
	if ReplicatedStorage_upvr.world.weather.Value == "Windy" then
		return {
			Luck = arg1.Luck * 2;
			Lure = arg1.Lure * 2;
			ProgressSpeed = arg1.ProgressSpeed * 2;
		}
	end
end
tbl.ConditionalBoosts = ConditionalBoosts
tbl.RelicGroup = "Default"
tbl_5.Breezed = tbl
tbl_5.Insight = {
	Description = "<$XpMultiply$>\xD7 XP after catching a fish, Lure Speed increased by <$Lure$>%, & grants a <$Mutations.1.Chance$>% chance to Purify caught fish";
...
tbl_5.Clever = {
	Description = "<$XpMultiply$>\xD7 XP after catching a fish";
...
local function ConditionalBoosts(arg1, arg2) -- Line 618
...
tbl_4.ConditionalBoosts = ConditionalBoosts
tbl_4.RelicGroup = "Default"
tbl_5.Abyssal = tbl_4
tbl_5.Herculean = {
...
local function ConditionalBoosts(arg1, arg2) -- Line 755
...
tbl_2.ConditionalBoosts = ConditionalBoosts
tbl_2.RelicGroup = "Default"
tbl_5.Flashline = tbl_2
tbl_5.Scavenger = {
...
local function ConditionalBoosts(arg1, arg2) -- Line 860
	return {
		ProgressSpeed = arg2:GetAttribute("CurrentMomentumBoost") or 0;
		Lure = arg2:GetAttribute("CurrentMomentumBoost") or 0;
		Resilience = arg2:GetAttribute("CurrentMomentumBoost") or 0;
	}
end
tbl_6.ConditionalBoosts = ConditionalBoosts
tbl_5.Momentum = tbl_6
tbl_5.Overclocked = {
...
tbl_5.Tenacity = {
	...
	Secondary = true;
	RelicGroup = "Cosmic";
	ConditionalBoosts = function(arg1, arg2) -- Line 892, Named "ConditionalBoosts"
		return {
			ProgressSpeed = arg2:GetAttribute("TenacityBoost");
		}
	end;
}
tbl_5.Tryhard = {
