...
var11_upvr.Boulder = {
	...
	Chance = 0;
	StrictZoneChance = 0.0001;
	StrictZoneOdds = "1/1000000";
	Rarity = "Divine Secret";
	Resilience = 50000;
	ForcedProgressEfficiency = 0.01;
	Description = "It's not a boulder, it's a-... Nevermind.";
	Hint = "???";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 10;
...
var11_upvr["Metal Strongbox"] = {
	Icon = "rbxassetid://111405279628709";
	WeightPool = {300, 300};
	Chance = 2;
	Rarity = "Rare";
	Resilience = 50;
	Description = "A large heavy duty crate, lost from some sort of underground civilization. The date of it's disappearance is unknown. Therefore, finders keepers?- Opening it might give you an array of fish, and money!";
	...
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"A Metal Strongbox!", "A Strongbox!", "Woah! A Strongbox!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("crate");
	IsCrate = true;
	CrateType = "All";
	FishContents = {"Rock", "Stalactite", "Conger Eel", "Lanternfish", "Pelagic Cod", "Bumpy Snailfish"};
	BaitContents = {"Garbage", "Worm", "Seaweed", "Coral", "Magnet", "Shark Head", "Luminous Larva"};
	CoinContents = {330, 450};
	From = "Tidefall";
}
var11_upvr["Giant Grouper"] = {
	Icon = "rbxassetid://102422178185308";
	WeightPool = {150000, 400000};
	Chance = 20;
	Rarity = "Rare";
	Resilience = 50;
	Description = "A massive reef predator that lurks in caves and shipwrecks.";
	Hint = "Found near deep structures. Fished with heavy tackle.";
	FavouriteBait = "Squid";
	FavouriteTime = "Night";
	Price = 420;
	XP = 250;
	...
	Weather = {"Clear", "Rain"};
	Quips = {"A Giant Grouper!", "Reef behemoth!", "Patriarch of the wreck!"};
	SparkleColor = Color3.fromRGB(100, 70, 40);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Tidefall";
}
var11_upvr.Dripstone = {
	...
	Rarity = "Trash";
	Resilience = 300;
	Description = "A giant piece of slate that fell from the roof of Tidefall, nobody knows how a rod could ever pick this up...";
	Hint = "Found in shallow rockpools and caves.";
	FavouriteBait = "None";
	FavouriteTime = "None";
	Price = 550;
	XP = 2;
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"A Dripstone!", "IT'S GIANT!", "OW IT'S POINTY!"};
	SparkleColor = Color3.fromRGB(29, 30, 36);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Tidefall";
}
var11_upvr["Moray Eel"] = {
	Icon = "rbxassetid://77546277641994";
	WeightPool = {8000, 25000};
	Chance = 40;
	Rarity = "Unusual";
	Resilience = 65;
	Description = "A sinuous predator with sharp teeth, hiding in reef crevices.";
	Hint = "Lurks in holes and wrecks. Bites fiercely when hooked.";
	...
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"A Moray Eel!", "Snake of the sea!", "Gaping jaws!"};
	SparkleColor = Color3.fromRGB(60, 60, 60);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Tidefall";
}
var11_upvr["Conger Eel"] = {
	Icon = "rbxassetid://91624846934892";
	WeightPool = {100, 500};
	Chance = 30;
	Rarity = "Rare";
	Resilience = 55;
	Description = "A large, bottom-dwelling eel with powerful muscles.";
	Hint = "Found in deep, muddy bottoms near wrecks.";
	FavouriteBait = "Fish Head";
	FavouriteTime = "Night";
	Price = 380;
	XP = 230;
	...
	Weather = {"Rain", "Foggy"};
	Quips = {"A Conger Eel!", "Deep-water monster!", "A powerful fight!"};
	SparkleColor = Color3.fromRGB(40, 40, 50);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Tidefall";
}
var11_upvr["Sixgill Shark"] = {
	...
	Description = "A primitive deep-water shark with six gill slits and a heavy body.";
	Hint = "Prowls the deepest trenches of Tidefall.";
	...
	Seasons = {"Winter"};
	Weather = {"Foggy"};
	Quips = {"A SIXGILL SHARK!", "PREHISTORIC HUNTER!", "FROM THE ABYSS!"};
	SparkleColor = Color3.fromRGB(80, 100, 120);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Tidefall";
}
var11_upvr.Lanternfish = {
	Icon = "rbxassetid://113661277177940";
	WeightPool = {5, 30};
	Chance = 75;
	Rarity = "Common";
	Resilience = 85;
	Description = "A small deep-sea fish with bioluminescent organs.";
	Hint = "Rises to mid-water at night. Attracted to light.";
	...
	Seasons = {"None"};
	Weather = {"Clear"};
	Quips = {"A Lanternfish!", "Tiny deep-sea beacon!", "Glowing in the dark!"};
	SparkleColor = Color3.fromRGB(0, 200, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Tidefall";
}
var11_upvr["Gulper Eel"] = {
	Icon = "rbxassetid://95039408644114";
	WeightPool = {2000, 10000};
	Chance = 25;
	Rarity = "Unusual";
	Resilience = 60;
	Description = "A strange deep-sea eel with an enormous, pouch-like mouth.";
	Hint = "Found in the midnight zone. Swallows prey whole.";
	FavouriteBait = "Squid";
	FavouriteTime = "Night";
	Price = 280;
	XP = 170;
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Gulper Eel!", "Living fishing net!", "Bizarre deep-sea oddity!"};
	SparkleColor = Color3.fromRGB(150, 100, 180);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Tidefall";
}
var11_upvr["Pelagic Cod"] = {
	Icon = "rbxassetid://104249030711851";
	WeightPool = {3000, 12000};
	Chance = 65;
	Rarity = "Common";
	Resilience = 80;
	Description = "A silvery fish that schools in open water far from the bottom.";
	Hint = "Found in mid-water columns. Schooling fish.";
	...
	Weather = {"Clear", "Windy"};
	Quips = {"A Pelagic Cod!", "Open-water wanderer!", "Silver flash in the blue!"};
	SparkleColor = Color3.fromRGB(220, 220, 220);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Tidefall";
}
var11_upvr["Bumpy Snailfish"] = {
	Icon = "rbxassetid://139143154164638";
	WeightPool = {500, 2000};
	Chance = 50;
	Rarity = "Uncommon";
	Resilience = 70;
	Description = "A soft-bodied, gelatinous fish adapted to extreme depths.";
	Hint = "Lives on the seafloor in freezing, high-pressure zones.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "None";
	Price = 180;
	XP = 110;
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Bumpy Snailfish!", "Deep-sea jelly!", "Pressure-resistant oddity!"};
	SparkleColor = Color3.fromRGB(255, 200, 200);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Tidefall";
}
var11_upvr.Plesiosaur = {
	...
	Rarity = "Exotic";
	Resilience = -10;
	Description = "A prehistoric marine reptile, long-necked and powerful, thought extinct for millions of years.";
	Hint = "A living fossil haunting the deepest, darkest trenches.";
	FavouriteBait = "Shark Head";
	FavouriteTime = "Night";
	Price = 50000;
	XP = 40000;
	Seasons = {"Winter"};
	Weather = {"Foggy"};
	Quips = {"A PLESIOSAUR!", "PREHISTORIC LEVIATHAN!", "FROM THE AGE OF REPTILES!"};
	SparkleColor = Color3.fromRGB(0, 100, 150);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Tidefall";
...
var11_upvr["Forbidden Plesiosaur"] = {
	...
	Chance = 0;
	StrictZoneChance = 0.0002;
	StrictZoneOdds = "1/500000";
	Rarity = "Divine Secret";
	Resilience = -100;
	Description = "A prehistoric marine reptile, long-necked and powerful, thought extinct for millions of years.";
	Hint = "A living fossil haunting the deepest, darkest trenches.";
...
var11_upvr.Anchor = {
	...
	Rarity = "Mythical";
	Resilience = 75;
	Description = "A massive, ancient ship's anchor, covered in rust and barnacles.";
	Hint = "Snagged on the seafloor near wrecks. A test of strength.";
	FavouriteBait = "Magnet";
	FavouriteTime = "None";
	Price = 6200;
	XP = 4190;
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"An Anchor!", "Heavy maritime history!", "Tethered to the past!"};
	SparkleColor = Color3.fromRGB(100, 100, 100);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Tidefall";
}
var11_upvr.Batfish = {
	...
	Rarity = "Common";
	Resilience = 85;
	Description = "A strangely shaped fish with elongated fins that resemble wings.";
	Hint = "Hovers near coral heads and seagrass beds.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "Day";
	Price = 70;
	XP = 45;
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"A Batfish!", "Underwater glider!", "Odd and graceful!"};
	SparkleColor = Color3.fromRGB(200, 150, 100);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Coral Bastion";
}
var11_upvr.Lizardfish = {
	Icon = "rbxassetid://102967342721637";
	WeightPool = {300, 1200};
	Chance = 70;
	Rarity = "Common";
	Resilience = 80;
	Description = "A predatory fish with a mouth full of needle-like teeth.";
	Hint = "Lies buried in sand, ambushing passing prey.";
	FavouriteBait = "Minnow";
	FavouriteTime = "Night";
	Price = 75;
	XP = 50;
	...
	Weather = {"Clear"};
	Quips = {"A Lizardfish!", "Ambush predator!", "Needle-toothed lurker!"};
	SparkleColor = Color3.fromRGB(120, 100, 80);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Coral Bastion";
}
var11_upvr.Scorpionfish = {
	Icon = "rbxassetid://77435173650490";
	WeightPool = {50, 200};
	Chance = 60;
	Rarity = "Uncommon";
	Resilience = 75;
	Description = "A master of camouflage with venomous spines along its back.";
	Hint = "Disguised as a rock or coral. Dangerous to handle.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "Day";
	Price = 160;
	XP = 95;
	Seasons = {"Summer", "Autumn"};
	Weather = {"Clear"};
	Quips = {"A Scorpionfish!", "Venomous and hidden!", "Watch the spines!"};
	SparkleColor = Color3.fromRGB(255, 100, 50);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Coral Bastion";
}
var11_upvr["Sand Tiger Shark"] = {
	Icon = "rbxassetid://93065941991146";
	WeightPool = {50000, 120000};
	Chance = 3;
	Rarity = "Mythical";
	Resilience = 10;
	Description = "A shark with a menacing grin and ragged teeth, often seen near reefs.";
	Hint = "Cruises slowly along drop-offs and shipwrecks.";
	FavouriteBait = "Fish Head";
	FavouriteTime = "Night";
	Price = 4500;
	XP = 2700;
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"A Sand Tiger Shark!", "Smiling menace!", "Reef patrol!"};
	SparkleColor = Color3.fromRGB(180, 170, 140);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Coral Bastion";
}
var11_upvr["Wobbegong Shark"] = {
	Icon = "rbxassetid://76725883680963";
	WeightPool = {15000, 40000};
	Chance = 3;
	Rarity = "Mythical";
	Resilience = 10;
	Description = "A flat, patterned 'carpet shark' that lies perfectly still on the seafloor.";
	Hint = "Camouflaged on sandy bottoms near coral. Ambush predator.";
	FavouriteBait = "Squid";
	FavouriteTime = "Night";
	Price = 4600;
	XP = 1550;
	Seasons = {"Spring", "Autumn"};
	Weather = {"Clear"};
	Quips = {"A Wobbegong!", "Living carpet!", "Master of disguise!"};
	SparkleColor = Color3.fromRGB(90, 70, 50);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Coral Bastion";
}
var11_upvr["Emperor Angelfish"] = {
	Icon = "rbxassetid://87364699216951";
	WeightPool = {5, 15};
	Chance = 50;
	Rarity = "Uncommon";
	Resilience = 70;
	Description = "A stunningly vibrant reef fish with bold blue and yellow stripes.";
	Hint = "Swims gracefully among the most colorful coral formations.";
	FavouriteBait = "Coral";
	FavouriteTime = "Day";
	Price = 200;
	XP = 120;
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"An Emperor Angelfish!", "Jewel of the reef!", "Royal colors!"};
	SparkleColor = Color3.fromRGB(0, 100, 255);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Coral Bastion";
}
var11_upvr["Regal Angelfish"] = {
	Icon = "rbxassetid://110519833570355";
	WeightPool = {4, 12};
	Chance = 55;
	Rarity = "Uncommon";
	Resilience = 72;
	Description = "A delicate, ornate fish with fine orange and white lines on a dark blue body.";
	Hint = "Prefers sheltered ledges and overhangs on the reef.";
	FavouriteBait = "Coral";
	FavouriteTime = "Day";
	Price = 190;
	XP = 115;
	Seasons = {"Spring", "Summer"};
	Weather = {"Clear"};
	Quips = {"A Regal Angelfish!", "Finely dressed!", "Elegant swimmer!"};
	SparkleColor = Color3.fromRGB(255, 150, 0);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Coral Bastion";
}
var11_upvr["Bigeye Trevally"] = {
	Icon = "rbxassetid://140281882122071";
	WeightPool = {8, 25};
	Chance = 45;
	Rarity = "Unusual";
	Resilience = 60;
	Description = "A powerful, silvery predator with large eyes, hunting in schools.";
	Hint = "Patrols the outer edges of the reef in fast-moving groups.";
	FavouriteBait = "Minnow";
	FavouriteTime = "Night";
	Price = 275;
	XP = 165;
	Seasons = {"Summer", "Autumn"};
	Weather = {"Windy"};
	Quips = {"A Bigeye Trevally!", "Silver speedster!", "School hunter!"};
	SparkleColor = Color3.fromRGB(200, 200, 220);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Coral Bastion";
}
var11_upvr["Atlantic Goliath Grouper"] = {
	...
	Description = "A titanic, slow-moving grouper that inhabits wrecks and reefs.";
	Hint = "A living boulder guarding its territory. An epic struggle.";
	FavouriteBait = "Shark Head";
	FavouriteTime = "Day";
	Price = 1850;
	XP = 1480;
	Seasons = {"Summer"};
	Weather = {"Clear", "Rain"};
	Quips = {"A GOLIATH GROUPER!", "THE REEF'S GUARDIAN!", "COLOSSAL CATCH!"};
	SparkleColor = Color3.fromRGB(110, 80, 60);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Coral Bastion";
}
var11_upvr["Reef Titan"] = {
	...
	Rarity = "Exotic";
	Resilience = -20;
	Description = "A mythical, colossal creature that is part of the reef itself. Its movements cause tremors, and its size defies belief.";
	Hint = "The heart of Coral Bastion. It does not wake lightly.";
	FavouriteBait = "None";
	FavouriteTime = "None";
	Price = 35000;
	XP = 20000;
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"THE REEF TITAN!", "LIVING MONUMENT!", "EARTHQUAKE OF THE SEA!"};
	SparkleColor = Color3.fromRGB(0, 200, 150);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Coral Bastion";
	ClientFishingPassives = {
		MegalodonBehavior = {
...
var11_upvr["Colossus Reef Titan"] = {
	...
	Rarity = "Secret";
	Resilience = -80;
	Description = "A mythical, extra colossal creature that is part of the reef itself. Its movements cause tremors, and its size defies belief.";
	Hint = "The heart of Coral Bastion. It does not wake lightly.";
	FavouriteBait = "None";
	FavouriteTime = "None";
	Price = 68000;
	...
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"THE COLOSSUS REEF TITAN!", "LIVING MONUMENT!", "EARTHQUAKE OF THE SEA!"};
	SparkleColor = Color3.fromRGB(0, 200, 150);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Coral Bastion";
	ClientFishingPassives = {
...
var11_upvr["Deepwater Stingray"] = {
	Icon = "rbxassetid://93167111479291";
	WeightPool = {80, 100};
	Chance = 35;
	Rarity = "Unusual";
	Resilience = 65;
	Description = "A large, dark ray that glides over the silty abyssal plains.";
	Hint = "Buried in sediment during the day, active at night.";
	FavouriteBait = "Squid";
	FavouriteTime = "Night";
	Price = 290;
	XP = 175;
	Seasons = {"Autumn", "Winter"};
	Weather = {"Clear"};
	Quips = {"A Deepwater Stingray!", "Ghost of the abyss!", "Silent glider!"};
	SparkleColor = Color3.fromRGB(50, 50, 70);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Sunken Reliquary";
}
var11_upvr["Flying Gurnard"] = {
	Icon = "rbxassetid://86739447959115";
	WeightPool = {20, 40};
	Chance = 15;
	Rarity = "Legendary";
	Resilience = 15;
	Description = "A bizarre fish with wing-like pectoral fins that 'walk' on the seafloor.";
	Hint = "Forages on sandy bottoms, spreading colorful 'wings' when threatened.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "Day";
	Price = 2700;
	XP = 1205;
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"A Flying Gurnard!", "Seafloor butterfly!", "Wings of the deep!"};
	SparkleColor = Color3.fromRGB(255, 100, 150);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Sunken Reliquary";
}
var11_upvr["Small-Spotted Catshark"] = {
	Icon = "rbxassetid://100095896023547";
	WeightPool = {2000, 8000};
	Chance = 5;
	Rarity = "Mythical";
	Resilience = 1;
	Description = "A small, spotted shark that rests on the bottom during the day.";
	Hint = "Found hiding under rocks and in crevices.";
	FavouriteBait = "None";
	FavouriteTime = "Night";
	Price = 4110;
	XP = 2265;
	Seasons = {"Spring", "Autumn"};
	Weather = {"Clear"};
	Quips = {"A Catshark!", "Little spotted shark!", "Nocturnal hunter!"};
	SparkleColor = Color3.fromRGB(140, 120, 100);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Sunken Reliquary";
}
var11_upvr.Oilfish = {
	...
	Rarity = "Unusual";
	Resilience = 62;
	Description = "A deep-water fish with oily, indigestible flesh. A challenging catch.";
	Hint = "Lives in mid-water over deep canyons.";
	FavouriteBait = "Squid";
	FavouriteTime = "Night";
	Price = 255;
	XP = 155;
	Seasons = {"Winter"};
	Weather = {"Rain"};
	Quips = {"An Oilfish!", "Slippery and deep!", "Oily and strong!"};
...
var11_upvr.Escolar = {
	...
	Rarity = "Unusual";
	Resilience = 60;
	Description = "A fast, waxy-fleshed predator of the deep open ocean.";
	Hint = "Caught while trolling or deep-dropping over trenches.";
	FavouriteBait = "Fish Head";
	FavouriteTime = "Night";
	Price = 265;
	XP = 160;
	Seasons = {"Autumn"};
	Weather = {"Windy"};
	Quips = {"An Escolar!", "Deep-sea speedster!", "Waxy warrior!"};
	SparkleColor = Color3.fromRGB(150, 130, 100);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Sunken Reliquary";
}
var11_upvr["Cusk Eel"] = {
	...
	Rarity = "Rare";
	Resilience = 52;
	Description = "A long, slender eel-like fish with a distinctive whisker on its chin.";
	Hint = "Inhabits the muddy floor of the deepest trenches.";
	FavouriteBait = "Squid";
	FavouriteTime = "Night";
	Price = 360;
	XP = 215;
	Seasons = {"Winter"};
	Weather = {"Foggy"};
	Quips = {"A Giant Cusk Eel!", "Whiskered wonder!", "Ghost of the trench!"};
	SparkleColor = Color3.fromRGB(120, 100, 120);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Sunken Reliquary";
}
var11_upvr.Porcupinefish = {
	Icon = "rbxassetid://86333804551453";
	WeightPool = {1000, 5000};
	Chance = 55;
	Rarity = "Uncommon";
	Resilience = 68;
	Description = "A fish that inflates into a spiny ball when threatened.";
	Hint = "Slow-moving around reefs and rubble.";
	FavouriteBait = "None";
	FavouriteTime = "Day";
	Price = 145;
	XP = 90;
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"A Porcupinefish!", "Prickly balloon!", "Inflatable defense!"};
	SparkleColor = Color3.fromRGB(200, 180, 100);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Sunken Reliquary";
}
var11_upvr["John Dory"] = {
	Icon = "rbxassetid://123463652418225";
	WeightPool = {20, 80};
	Chance = 50;
	Rarity = "Uncommon";
	Resilience = 70;
	Description = "A thin, disc-shaped fish with a prominent black spot on its side.";
	Hint = "A stealthy hunter, often seen standing vertically in the water.";
	FavouriteBait = "Minnow";
	FavouriteTime = "Day";
	Price = 155;
	XP = 95;
	Seasons = {"Spring", "Autumn"};
	Weather = {"Clear"};
	Quips = {"A John Dory!", "Saint Peter's fish!", "Sideways stare!"};
	SparkleColor = Color3.fromRGB(180, 160, 120);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Sunken Reliquary";
}
var11_upvr.Cornetfish = {
	Icon = "rbxassetid://126780067412587";
	WeightPool = {80, 300};
	Chance = 70;
	Rarity = "Common";
	Resilience = 82;
	Description = "An extremely long, thin fish with a tubular snout.";
	Hint = "Hovers motionless among seagrass, striking at small prey.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "Day";
	Price = 85;
	XP = 50;
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"A Cornetfish!", "Living fishing rod!", "Slender and swift!"};
	SparkleColor = Color3.fromRGB(100, 150, 100);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Sunken Reliquary";
}
var11_upvr.Omnithal = {
	...
	Rarity = "Exotic";
	Resilience = -20;
	Description = "A bioluminescent leviathan with multiple glowing eyes, said to guard the deepest, oldest wrecks.";
	Hint = "The guardian of the Sunken Reliquary. Drawn to powerful light and sound.";
	...
	Seasons = {"Winter"};
	Weather = {"Foggy"};
	Quips = {"OMNITHAL!", "GUARDIAN OF RELICS!", "MANY-EYED WATCHER!"};
...
var11_upvr["Awakened Omnithal"] = {
	...
	ClientFishingPassives = {
		MegalodonBehavior = {
			...
			Duration = 1.8;
			AnimTime = 0.4;
			Color = Color3.fromRGB(255, 102, 56);
		};
	};
}
var11_upvr["Copper Rockfish"] = {
	Icon = "rbxassetid://117531971818083";
	WeightPool = {10, 50};
	Chance = 75;
	Rarity = "Common";
	Resilience = 80;
	Description = "A hardy, coppery-colored fish that lives among rocky outcrops.";
	Hint = "Found close to the bottom near ruins and rocks.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "Day";
	Price = 95;
	XP = 60;
	Seasons = {"Spring", "Summer"};
	Weather = {"Clear"};
	Quips = {"A Copper Rockfish!", "Metallic dweller!", "Rocky bottom resident!"};
...
var11_upvr.Opah = {
	...
	Rarity = "Rare";
	Resilience = 50;
	Description = "A large, disc-shaped, warm-blooded fish with stunning bright red fins.";
	Hint = "A solitary wanderer of open deep water near structures.";
	FavouriteBait = "Squid";
	FavouriteTime = "Day";
	Price = 480;
	XP = 290;
	Seasons = {"Autumn"};
	Weather = {"Clear"};
	Quips = {"An Opah!", "Moonfish!", "Warm-blooded wonder!"};
	SparkleColor = Color3.fromRGB(255, 50, 50);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Collapsed Ruins";
}
var11_upvr["Blackfin Icefish"] = {
	Icon = "rbxassetid://73433938748549";
	WeightPool = {800, 3000};
	Chance = 65;
	Rarity = "Uncommon";
	Resilience = 72;
	Description = "A pale, translucent fish adapted to freezing Antarctic waters.";
	Hint = "Found in the coldest, darkest depths of the ruins.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "None";
	Price = 175;
	XP = 105;
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Blackfin Icefish!", "Ghost of the ice!", "Bloodless wonder!"};
	SparkleColor = Color3.fromRGB(200, 220, 240);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Collapsed Ruins";
}
var11_upvr["Roughhead Grenadier"] = {
	Icon = "rbxassetid://129522123122384";
	WeightPool = {2000, 8000};
	Chance = 55;
	Rarity = "Common";
	Resilience = 78;
	Description = "A rattail fish with a large head and tapered body, common in deep water.";
	Hint = "Forages on the muddy seafloor of the abyss.";
	FavouriteBait = "Squid";
	FavouriteTime = "Night";
	Price = 105;
	XP = 65;
	Seasons = {"Autumn", "Winter"};
	Weather = {"Clear"};
	Quips = {"A Roughhead Grenadier!", "Deep-sea rat tail!", "Bottom feeder!"};
	SparkleColor = Color3.fromRGB(120, 100, 80);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Collapsed Ruins";
}
var11_upvr["Longnose Chimaera"] = {
	Icon = "rbxassetid://118074424130644";
	WeightPool = {5000, 20000};
	Chance = 35;
	Rarity = "Unusual";
	Resilience = 65;
	Description = "A ghostly, primitive fish with a long snout and venomous spine.";
	Hint = "Glides through dark waters with eerie grace.";
	FavouriteBait = "Squid";
	FavouriteTime = "Night";
	Price = 270;
	XP = 165;
	Seasons = {"Winter"};
	Weather = {"Foggy"};
	Quips = {"A Longnose Chimaera!", "Ghost shark!", "Living fossil!"};
	SparkleColor = Color3.fromRGB(180, 180, 220);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Collapsed Ruins";
}
var11_upvr["Shortnose Chimaera"] = {
	Icon = "rbxassetid://126367088180383";
	WeightPool = {3000, 12000};
	Chance = 40;
	Rarity = "Uncommon";
	Resilience = 68;
	Description = "A smaller relative of the chimaera with a blunt snout and large eyes.";
	Hint = "Dwells in the shadowy depths near underwater cliffs.";
	FavouriteBait = "Squid";
	FavouriteTime = "Night";
	Price = 185;
	XP = 110;
	Seasons = {"Autumn", "Winter"};
	Weather = {"Clear"};
	Quips = {"A Shortnose Chimaera!", "Little ghost shark!", "Deep-sea oddity!"};
	SparkleColor = Color3.fromRGB(160, 160, 200);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Collapsed Ruins";
}
var11_upvr["Bigeye Houndshark"] = {
	Icon = "rbxassetid://94161525195510";
	WeightPool = {8000, 25000};
	Chance = 45;
	Rarity = "Unusual";
	Resilience = 62;
	Description = "A slender shark with enormous eyes for hunting in dim light.";
	Hint = "Active at dawn and dusk along the seafloor.";
	FavouriteBait = "Fish Head";
	FavouriteTime = "Night";
	Price = 250;
	XP = 150;
	Seasons = {"Spring", "Autumn"};
	Weather = {"Clear"};
	Quips = {"A Bigeye Houndshark!", "Nocturnal hunter!", "Eyes like saucers!"};
	SparkleColor = Color3.fromRGB(100, 100, 120);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Collapsed Ruins";
}
var11_upvr["Atlantic Halosaur"] = {
	Icon = "rbxassetid://84147697486477";
	WeightPool = {4000, 15000};
	Chance = 50;
	Rarity = "Uncommon";
	Resilience = 70;
	Description = "An eel-like fish with a distinctive upturned tail, probing the mud with its snout.";
	Hint = "Burrows in soft sediment for worms and crustaceans.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "Day";
	Price = 165;
	XP = 100;
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"An Atlantic Halosaur!", "Seafloor probe!", "Upturned tail!"};
	SparkleColor = Color3.fromRGB(150, 130, 100);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Collapsed Ruins";
}
var11_upvr["Blackfin Barracuda"] = {
	Icon = "rbxassetid://137655505780012";
	WeightPool = {100, 400};
	Chance = 10;
	Rarity = "Legendary";
	Resilience = 15;
	Description = "A sleek, torpedo-shaped predator with jet-black fins and razor teeth.";
	Hint = "Ambushes prey from the shadows of ruins and pillars.";
	FavouriteBait = "Minnow";
	FavouriteTime = "Night";
	Price = 2390;
	XP = 1235;
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"A Blackfin Barracuda!", "Black-finned terror!", "Speed demon!"};
	SparkleColor = Color3.fromRGB(30, 30, 30);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Collapsed Ruins";
}
var11_upvr["Black Scabbardfish"] = {
	Icon = "rbxassetid://139426103317048";
	WeightPool = {500, 2000};
	Chance = 2;
	Rarity = "Mythical";
	Resilience = 3;
	Description = "An extremely long, slender fish with a ribbon-like body and fanged jaws.";
	Hint = "Hunts in the water column above deep canyons.";
	FavouriteBait = "Squid";
	FavouriteTime = "Night";
	Price = 4280;
	XP = 3170;
	Seasons = {"Autumn", "Winter"};
	Weather = {"Windy"};
	Quips = {"A Black Scabbardfish!", "Living blade!", "Deep-sea ribbon!"};
	SparkleColor = Color3.fromRGB(20, 20, 40);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Collapsed Ruins";
}
var11_upvr.Pliosaur = {
	...
	Rarity = "Exotic";
	Resilience = -15;
	Description = "A monstrous marine reptile from the age of dinosaurs, with a skull larger than a man and jaws built to crush.";
	Hint = "The apex predator of the Collapsed Ruins. Feeds on whales and other giants.";
	FavouriteBait = "Shark Head";
	FavouriteTime = "Night";
	Price = 45000;
	XP = 36000;
	Seasons = {"Winter"};
	Weather = {"Foggy"};
	Quips = {"A PLIOSAUR!", "SEA DRAGON!", "JAWS OF EXTINCTION!"};
	SparkleColor = Color3.fromRGB(0, 80, 120);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Collapsed Ruins";
	ClientFishingPassives = {
		MegalodonBehavior = {
			...
			Duration = 2.8;
			AnimTime = 0.9;
			Color = Color3.fromRGB(98, 122, 203);
		};
	};
}
var11_upvr["Ancestral Pliosaur"] = {
	...
	ClientFishingPassives = {
		MegalodonBehavior = {
			...
			Duration = 2.5;
			AnimTime = 0.7;
			Color = Color3.fromRGB(203, 41, 0);
		};
	};
}
var11_upvr.Gnomefish = {
	Icon = "rbxassetid://96940226147317";
	WeightPool = {20, 80};
	Chance = 80;
	Rarity = "Common";
	Resilience = 85;
	Description = "A small, stout fish with a grumpy expression and spiny fins.";
	Hint = "Hides among rubble and broken pottery on the seafloor.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "Day";
	Price = 65;
	XP = 40;
	Seasons = {"Spring", "Summer"};
	Weather = {"Clear"};
	Quips = {"A Gnomefish!", "Grumpy bottom-dweller!", "Little sea gnome!"};
	SparkleColor = Color3.fromRGB(150, 120, 90);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Crowned Ruins";
}
var11_upvr["Blackmouth Catshark"] = {
	Icon = "rbxassetid://101213070473173";
	WeightPool = {1500, 6000};
	Chance = 3;
	Rarity = "Mythical";
	Resilience = 5;
	Description = "A small shark with a distinctive black interior to its mouth.";
	Hint = "Nocturnal hunter among ruins and coral rubble.";
	FavouriteBait = "None";
	FavouriteTime = "Night";
	Price = 5000;
	XP = 3600;
	Seasons = {"Summer", "Autumn"};
	Weather = {"Clear"};
	Quips = {"A Blackmouth Catshark!", "Little night shark!", "Inky mouth!"};
	SparkleColor = Color3.fromRGB(80, 80, 100);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Crowned Ruins";
}
var11_upvr["Silver Roughy"] = {
	Icon = "rbxassetid://84411234761700";
	WeightPool = {1000, 4000};
	Chance = 65;
	Rarity = "Uncommon";
	Resilience = 75;
	Description = "A bright silver fish with rough scales, living in deep aggregations.";
	Hint = "Forms large schools over seamounts and ruins.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "Day";
	Price = 155;
	XP = 95;
	Seasons = {"Autumn"};
	Weather = {"Clear"};
	Quips = {"A Silver Roughy!", "Living silver coin!", "Deep-sea schooler!"};
	SparkleColor = Color3.fromRGB(200, 200, 220);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Crowned Ruins";
}
var11_upvr["Roundnose Grenadier"] = {
	Icon = "rbxassetid://78330707624915";
	WeightPool = {3000, 12000};
	Chance = 60;
	Rarity = "Common";
	Resilience = 78;
	Description = "A rattail fish with a rounded snout and long tapering tail.";
	Hint = "Common on deep muddy plains surrounding the ruins.";
	FavouriteBait = "Squid";
	FavouriteTime = "Night";
	Price = 110;
	XP = 70;
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Roundnose Grenadier!", "Rat of the deep!", "Bottom scavenger!"};
	SparkleColor = Color3.fromRGB(100, 80, 60);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Crowned Ruins";
}
var11_upvr["Warty Oreo"] = {
	Icon = "rbxassetid://113562633315955";
	WeightPool = {20, 80};
	Chance = 55;
	Rarity = "Uncommon";
	Resilience = 72;
	Description = "A deep-water fish with a compressed, disc-like body and rough scales.";
	Hint = "Lives near the seafloor on steep slopes.";
	FavouriteBait = "Squid";
	FavouriteTime = "Day";
	Price = 180;
	XP = 110;
	Seasons = {"Autumn", "Winter"};
	Weather = {"Clear"};
	Quips = {"A Warty Oreo!", "Deep-sea cookie!", "Bumpy disc fish!"};
	SparkleColor = Color3.fromRGB(120, 100, 80);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Crowned Ruins";
}
var11_upvr.Armorhead = {
	Icon = "rbxassetid://128370010114172";
	WeightPool = {5000, 20000};
	Chance = 45;
	Rarity = "Unusual";
	Resilience = 65;
	Description = "A large fish with a bony, armored head and strong jaws.";
	Hint = "Feeds on shellfish, crushing them with its powerful teeth.";
	FavouriteBait = "None";
	FavouriteTime = "Day";
	Price = 260;
	XP = 160;
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"An Armorhead!", "Bony-headed bruiser!", "Shell crusher!"};
	SparkleColor = Color3.fromRGB(90, 70, 50);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Crowned Ruins";
}
var11_upvr["Blackspot Tuskfish"] = {
	Icon = "rbxassetid://139140921864423";
	WeightPool = {8000, 30000};
	Chance = 40;
	Rarity = "Unusual";
	Resilience = 62;
	Description = "A colorful reef fish with prominent canine teeth and a black spot on its back.";
	Hint = "Uses its teeth to crush sea urchins and crabs.";
	FavouriteBait = "None";
	FavouriteTime = "Day";
	Price = 240;
	XP = 145;
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"A Blackspot Tuskfish!", "Toothy reef dweller!", "Spot on its back!"};
	SparkleColor = Color3.fromRGB(0, 150, 200);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Crowned Ruins";
}
var11_upvr["Tompot Blenny"] = {
	Icon = "rbxassetid://117527788843211";
	WeightPool = {100, 400};
	Chance = 35;
	Rarity = "Rare";
	Resilience = 48;
	Description = "A small, curious fish with tentacles above its eyes, peering from holes.";
	Hint = "Lives in empty shells and crevices in the ruins.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "Day";
	Price = 360;
	XP = 335;
	Seasons = {"Spring", "Summer"};
	Weather = {"Clear"};
	Quips = {"A Tompot Blenny!", "Curious face!", "Tentacled peekaboo!"};
	SparkleColor = Color3.fromRGB(200, 150, 50);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Crowned Ruins";
}
var11_upvr["Spotted Drum"] = {
	Icon = "rbxassetid://86038862428829";
	WeightPool = {10, 20};
	Chance = 65;
	Rarity = "Uncommon";
	Resilience = 74;
	Description = "A juvenile fish with extremely long dorsal fins, adults are more modestly sized.";
	Hint = "Juveniles hide among coral branches and sea fans.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "Night";
	Price = 170;
	XP = 105;
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"A Spotted Drum!", "Long-finned dancer!", "Spotted beauty!"};
	SparkleColor = Color3.fromRGB(255, 220, 150);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Crowned Ruins";
}
var11_upvr["Greater Weever"] = {
	Icon = "rbxassetid://76683409300619";
	WeightPool = {300, 1200};
	Chance = 60;
	Rarity = "Uncommon";
	Resilience = 70;
	Description = "A venomous fish that buries itself in sand, leaving only its eyes and dorsal spines exposed.";
	Hint = "Dangerous step! Hidden in sandy patches.";
	FavouriteBait = "Shrimp";
	FavouriteTime = "Day";
	Price = 190;
	XP = 115;
	Seasons = {"Summer"};
	Weather = {"Clear"};
	Quips = {"A Greater Weever!", "Venomous lurker!", "Watch your step!"};
	SparkleColor = Color3.fromRGB(255, 50, 50);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Crowned Ruins";
}
var11_upvr["Oil Sardine"] = {
	Icon = "rbxassetid://105680290444191";
	WeightPool = {50, 200};
	Chance = 85;
	Rarity = "Common";
	Resilience = 90;
	Description = "A small, oily fish that forms massive, shimmering schools.";
	Hint = "Feeds on plankton in the water column above the ruins.";
	...
	Seasons = {"Spring", "Summer"};
	Weather = {"Clear"};
	Quips = {"An Oil Sardine!", "Tiny silver flash!", "Schooling snack!"};
	SparkleColor = Color3.fromRGB(220, 220, 150);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Crowned Ruins";
}
var11_upvr["Black Snoek"] = {
	Icon = "rbxassetid://72288452163568";
	WeightPool = {100, 400};
	Chance = 5;
	Rarity = "Legendary";
	Resilience = 18;
	Description = "A long, slender predatory fish with a pointed snout and dark coloration.";
	Hint = "Hunts in packs in open water near ruins.";
	FavouriteBait = "Minnow";
	FavouriteTime = "Night";
	Price = 2110;
	XP = 1245;
	Seasons = {"Autumn"};
	Weather = {"Windy"};
	Quips = {"A Black Snoek!", "Dark dart!", "Pack hunter!"};
	SparkleColor = Color3.fromRGB(40, 40, 60);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Crowned Ruins";
}
var11_upvr.Goldwraith = {
	...
	Rarity = "Exotic";
	Resilience = -25;
	Description = "A spectral fish made of living gold, said to be the guardian spirit of the Crowned Ruins. Its passage leaves trails of light.";
	Hint = "The treasure of the Crowned Ruins. Appears only under specific, mysterious conditions.";
	...
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"THE GOLDWRAITH!", "LIVING TREASURE!", "SPIRIT OF THE RUINS!"};
...
var11_upvr.Seraphfin = {
	Icon = "rbxassetid://99997501497692";
	BlockPassiveCapture = true;
	WeightPool = {10, 100000};
	Chance = 0;
	GlobalStrictChance = 0.0004;
	StrictZoneOdds = "1/250000";
	Rarity = "Divine Secret";
	Resilience = -50;
	ProgressEfficiency = 0.05;
	Description = "A touch of the heavens above...";
	Hint = "???";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 60000;
...
var11_upvr["Cataclysm Carp"] = {
	Icon = "rbxassetid://103151010809501";
	BlockPassiveCapture = true;
	WeightPool = {10, 100000};
	Chance = 0;
	StrictZoneChance = 0.01;
	StrictZoneOdds = "1/10000";
	Rarity = "Divine Secret";
	Resilience = -50;
	ProgressEfficiency = 0.05;
	Description = "A carp infested with pure evil!";
	Hint = "???";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 60000;
...
var11_upvr["Paradox Piranha"] = {
	Icon = "rbxassetid://98783516596013";
	BlockPassiveCapture = true;
	WeightPool = {10, 100000};
	Chance = 0;
	StrictZoneChance = 0.005;
	StrictZoneOdds = "1/20000";
	Rarity = "Divine Secret";
	Resilience = -50;
	ProgressEfficiency = 0.05;
...
var11_upvr.Lumilotl = {
	...
	WeightPool = {10, 100000};
	Chance = 0;
	StrictZoneChance = 0.0075;
	StrictZoneOdds = "1/15000";
	Rarity = "Divine Secret";
	Resilience = -50;
	ProgressEfficiency = 0.05;
	Description = "A beautiful and elegant variant of Axolotl; it seems to have evolved?!";
	Hint = "???";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 60000;
...
var11_upvr.Tuskmaw = {
	...
	Resilience = -50;
	ProgressEfficiency = 0.05;
	Description = "An extremely dangerous octopus with giant tusks; known for destroying fish at the bottom of the ocean...";
	Hint = "???";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 60000;
...
var11_upvr.Razorfin = {
	...
	WeightPool = {10, 100000};
	Chance = 0;
	StrictZoneChance = 0.004;
	StrictZoneOdds = "1/25000";
	Rarity = "Divine Secret";
	Resilience = -50;
	ProgressEfficiency = 0.05;
	Description = "A scarred and extremely lethal shark; known for causing catastrophic ship accidents.";
	Hint = "???";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 60000;
...
var11_upvr["Crustal Colossus"] = {
	...
	Resilience = -50;
	ProgressEfficiency = 0.05;
	Description = "An absolutely colossal crab known for being absolutely destructive; yet surprisingly passive to most creatures.";
	Hint = "???";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 60000;
...
var11_upvr.Aetherfin = {
	...
	Resilience = -50;
	ProgressEfficiency = 0.05;
	Description = "A surreal form of manta ray; an extremely rare and unknown catch...";
	Hint = "???";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 60000;
...
var11_upvr["Confetti Carp"] = {
	...
	Rarity = "Limited";
	Resilience = 20.26;
	ProgressEfficiency = 0.74;
	Description = "Cheers to 2026; Happy New Years!";
	Hint = "Only obtainable during New Years";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 2026;
	XP = 2026;
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"HAPPY NEW YEARS!", "2026!!!", "WOOHOO!!!!!!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	AnnounceInChat = true;
	FromLimited = "New Years";
	From = "New Years";
}
var11_upvr["Party Pufferfish"] = {
...
var11_upvr.Eonshell = {
	...
	Chance = 1;
	BlockPassiveCapture = true;
	FinalChanceDivisor = 14;
	Rarity = "Limited";
	Resilience = -20.26;
	ProgressEfficiency = 0.074;
	Description = "Cheers to 2026; Happy New Years!";
	Hint = "Only obtainable during New Years";
...
var11_upvr["Santa's Relic"] = {
	...
	Description = "It seems Santa made some Relic's just for the Christmas occasion! It's absolutely packed with Fischmas spirit and pure joy; Merry Fischmas!";
	Hint = "Only can be obtained after Christmas Day.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 25000;
	XP = 15000;
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"Santa's Relic!", "Timeless treasure!", "Holiday heirloom!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("small");
	AnnounceInChat = true;
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr.Santalmon = {
	...
	Resilience = 120;
	ProgressEfficiency = 0.8;
	Description = "Santa... But as a Salmon?";
	Hint = "Only can be obtained on Christmas Day.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 250;
	XP = 150;
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"Santa's Salmon!", "Timeless treasure!", "Holiday heirloom!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	AnnounceInChat = true;
	FromLimited = "Fischmas 2";
...
var11_upvr["Christmas Mossjaw"] = {
	...
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"IT'S SO JOLLY!", "MERRY FISCHMAS!"};
	...
	ClientFishingPassives = {
		MossjawBehavior = {
			...
			AccelMultiply = 0;
			Duration = 1.8;
			Color = Color3.fromRGB(65, 80, 64);
		};
	};
}
var11_upvr["Christmas Ancient Kraken"] = {
	...
	ClientFishingPassives = {
		KrakenBehavior = {
			...
			LockTime = 1.4;
			FlingPower = 0.5;
			Color = Color3.fromRGB(213, 70, 70);
		};
	};
}
var11_upvr["Christmas Kraken"] = {
	...
	ClientFishingPassives = {
		KrakenBehavior = {
			...
			LockTime = 1;
			FlingPower = 0.25;
			Color = Color3.fromRGB(74, 255, 171);
		};
	};
}
var11_upvr["Christmas Megalodon"] = {
...
var11_upvr["Christmas Ancient Megalodon"] = {
...
var11_upvr["Christmas Phantom Megalodon"] = {
	...
	ClientFishingPassives = {
		MegalodonBehavior = {
			...
			Duration = 2;
			AnimTime = 0.5;
			Color = Color3.fromRGB(63, 76, 153);
		};
	};
}
var11_upvr["Christmas Scylla"] = {
...
var11_upvr["Christmas Leviathan"] = {
	...
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"I LOVE CHRISTMAS!", "MERRY FISCHMAS!"};
	SparkleColor = Color3.fromRGB(255, 0, 0);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Admin-Exclusive";
	Unregistered = true;
...
var11_upvr["Christmas Bloop Fish"] = {
	...
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"DA JOOOLLLLLLLLY BLOOP!", "MERRY FISCHMAS!"};
	SparkleColor = Color3.fromRGB(255, 0, 0);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Admin-Exclusive";
	Unregistered = true;
	...
	ClientFishingPassives = {
		BloopBehavior = {
			...
			ExtremeCooldown = 3;
			ExtremeDuration = 3;
			ExtremeProgressLossRatio = 0.4;
			ExtremeProgressLossFlat = 15;
			ExtremeChargeReset = 50;
			ExtremeControlReduce = 0.3;
			ExtremeFlingPower = 0.5;
		};
	};
}
var11_upvr["Pirate Turkey"] = {
...
var11_upvr["Bountiful Bait Crate"] = {
...
var11_upvr["Sand Worm"] = {
	...
	Resilience = -50;
	ForcedProgressEfficiency = 0.1;
	Description = "The Sand Worm, also known as the Heart Beast is one of the most destructive and feared monsters. From land and see, the Sand Worm is able to dig and leap around, eating anything in it's path. The Sand Worm is capable of hearing heartbeats from over 10,000 KM's away, meaning you are never truly safe when a sandstorm hits.";
	Hint = "Obtained when fishing during a Sandstorm admin event.";
	FavouriteBait = nil;
	FavouriteTime = "Day";
	Price = 50000;
	XP = 10000;
	Seasons = {"Summer"};
	Weather = {"Foggy"};
	Quips = {"A SAND WORM!!", "IT'S SO HEAVY!", "WHAT IS THIS THING?!", "WOAH!!!", "A GIANT WORM!!!!!", "SCOURGE OF THE SAND!!!"};
	SparkleColor = Color3.fromRGB(255, 186, 130);
	HoldAnimation = fish:WaitForChild("heavy");
	AnnounceInChat = true;
	From = "Admin-Exclusive";
	Unregistered = true;
...
var11_upvr["Neon Tetra"] = {
	...
	Seasons = {"Spring", "Summer"};
	Weather = {"Clear"};
	Quips = {"A Neon Tetra!", "Glowing like a jewel!", "Schoolâ€™s in session!"};
	SparkleColor = Color3.fromRGB(0, 191, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Lost Jungle";
}
var11_upvr["Cardinal Tetra"] = {
...
var11_upvr["Silver Arowana"] = {
	Icon = "rbxassetid://123930797041581";
	WeightPool = {3000, 12000};
	Chance = 25;
	Rarity = "Rare";
	Resilience = 55;
	Description = "A sleek predator that leaps for prey above the waterâ€™s surface.";
...
var11_upvr["Black Ghost Knifefish"] = {
...
var11_upvr["Electric Eel"] = {
	...
	Seasons = {"Summer", "Autumn"};
	Weather = {"Rain"};
	Quips = {"AN ELECTRIC EEL!", "CRACKLING WITH POWER!", "THE RIVERâ€™S LIGHTNING!"};
...
var11_upvr["Elder Mossjaw"] = {
	...
	ClientFishingPassives = {
		MossjawBehavior = {
			...
			AccelMultiply = 0;
			Duration = 1.8;
			Color = Color3.fromRGB(73, 80, 72);
		};
	};
}
var11_upvr["Birthday Squid"] = {
	...
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"HAPPY BIRTHDAY FISCH!", "I HATE DOBIG! W FISCH!", "ðŸ¥³ðŸ¥³ðŸ¥³ðŸ¥³ðŸ¥³ðŸ¥³ðŸ¥³ðŸ¥³ðŸ¥³ðŸ¥³", "ðŸŽ‰ðŸŽ‰ðŸŽ‰ðŸŽ‰ðŸŽ‰ðŸŽ‰ðŸŽ‰ðŸŽ‰ðŸŽ‰ðŸŽ‰ðŸŽ‰ðŸŽ‰ðŸŽ‰ðŸŽ‰ðŸŽ‰"};
	SparkleColor = Color3.fromRGB(211, 160, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	FromLimited = "Anniversary";
	From = "Anniversary";
}
var11_upvr["Birthday Dumbo Octopus"] = {
...
var11_upvr["Birthday Megalodon"] = {
	...
	FromLimited = "Anniversary";
	From = "Anniversary";
	RewardTitle = "ðŸŽ‰ðŸ¦ˆ";
}
var11_upvr["Birthday Cake"] = {
...
var11_upvr["Baby's First Balloon"] = {
...
var11_upvr["Corrupted Mosslurker"] = {
...
var11_upvr["Corrupted Megalodon"] = {
...
var11_upvr["Supersized Driftwood"] = {
...
var11_upvr["Supersized Mosslurker"] = {
...
var11_upvr["Supersized Bloop Fish"] = {
...
var11_upvr["Supersized Sea Pickle"] = {
...
var11_upvr["Fischipedia Accurate Pickle"] = {
...
var11_upvr["Lightning Bolt"] = {
	...
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"ðŸ’¥ðŸ’¥ðŸ’¥", "Insert loud thunder noise here."};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Admin-Exclusive";
	Unregistered = true;
...
var11_upvr.Raindrop = {
	...
	Rarity = "Special";
	Resilience = 30;
	Description = "You usually see these when its raining ðŸ˜ðŸ‘.";
	Hint = "???";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 10575;
...
var11_upvr["Colossal Blue Dragon"] = {
	...
	ClientFishingPassives = {
		ColossalDragonBehavior = {
			...
			LossTime = 1.2;
			ProgressGain = 15;
			ProgressLossRatio = 0.3;
			Color = Color3.fromRGB(82, 194, 255);
		};
	};
}
var11_upvr["Colossal Ancient Dragon"] = {
	...
	ClientFishingPassives = {
		ColossalDragonBehavior = {
			...
			LossTime = 1.2;
			ProgressGain = 20;
			ProgressLossRatio = 0.4;
			Color = Color3.fromRGB(135, 33, 33);
		};
	};
}
var11_upvr["Colossal Ethereal Dragon"] = {
	...
	ClientFishingPassives = {
		ColossalDragonBehavior = {
			...
			LossTime = 1.2;
			ProgressGain = 25;
			ProgressLossRatio = 0.35;
			Color = Color3.fromRGB(239, 192, 255);
		};
	};
}
var11_upvr["Bluelip Batfish"] = {
...
var11_upvr["Hawaiian Bobtail Squid"] = {
...
var11_upvr["Electric Blue Seahorse"] = {
...
var11_upvr["Japanese Dragon Eel"] = {
...
var11_upvr["Lithodes Megacantha"] = {
...
var11_upvr["Brighteyes Egg"] = {
	...
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"Iâ€™VE BEEN WAITINGâ€¦ THE ANTICIPATION IS OVER!!!"};
	SparkleColor = Color3.fromRGB(136, 136, 136);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Admin-Exclusive";
	Unregistered = true;
...
var11_upvr["Blinking Egg"] = {
	...
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"You blinked I win!", "You blinked. I didn't.", "Blink and youâ€™ll mis-, oh too late."};
	SparkleColor = Color3.fromRGB(136, 136, 136);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Admin-Exclusive";
	Unregistered = true;
...
var11_upvr["Puzzle Egg"] = {
	...
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"I caught itâ€¦ I think? It kind of caught me back.", "uhhh hello?", "Im puzzled on how i even caught this (get it)"};
	SparkleColor = Color3.fromRGB(136, 136, 136);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Admin-Exclusive";
	Unregistered = true;
...
var11_upvr["Shadow Egg"] = {
	...
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"It weighs nothing and everything.", "It doesnâ€™t belong here. But it waits here.", "Fading from light arises the dark."};
	SparkleColor = Color3.fromRGB(136, 136, 136);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Admin-Exclusive";
	Unregistered = true;
...
var11_upvr["Gargantuan Taco"] = {
	...
	Hint = "???";
	FavouriteBait = "ðŸ”¥ðŸ”¥ðŸ”¥";
	FavouriteTime = nil;
	Price = 9000;
	XP = 9000;
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"ðŸ”¥ðŸ”¥ðŸ”¥", "Gargantuan Taco Tuesday?", "Extra Spicy!!!", "large yum"};
...
var11_upvr.Taco = {
	...
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"ðŸ”¥", "Taco Tuesday?", "Spicy!!!", "yum"};
	SparkleColor = Color3.fromRGB(255, 157, 19);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Admin-Exclusive";
	Unregistered = true;
...
var11_upvr["Glacial Fragment"] = {
	...
	Resilience = 100;
	ProgressEfficiency = 1.1;
	Description = "A shimmering shard of ancient ice, etched with swirling patterns resembling turbulent ocean waves. Rumored to hold the essence of Snowburrowâ€™s frozen seas.";
	Hint = "???";
	FavouriteBait = "None";
	FavouriteTime = "None";
	Price = 3000;
...
var11_upvr.Penguin = {
	...
	Resilience = 5;
	ProgressEfficiency = 0.3;
	Description = "A playful penguin, waddling gracefully on the icy slopes. Rarely caught, itâ€™s known for its curious nature and habit of stealing from traps.";
...
var11_upvr["White Sturgeon"] = {
	...
	Description = "A majestic White Sturgeon, gliding through Snowburrowâ€™s icy depths. Its massive, armored body and silvery scales make it a legendary catch among anglers.";
	Hint = "???";
	FavouriteBait = "Truffle Worm";
	FavouriteTime = "Night";
	Price = 8480;
...
var11_upvr["Experimental Salmon"] = {
...
var11_upvr["Beach Ball Pufferfish"] = {
...
var11_upvr["Message in a Bottle"] = {
...
var11_upvr["Mango Smoothie"] = {
	...
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"ðŸ¥­!", "MANGO MANGO MANGO MANGO MANGO!"};
	SparkleColor = Color3.fromRGB(255, 157, 19);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Admin-Exclusive";
	Unregistered = true;
...
var11_upvr.Snowflake = {
	...
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"How hasn't it melted?", "Pretty!", "Too unique to last!", "Fragile!", "Blink and itâ€™s gone!", "One of a kind!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Admin-Exclusive";
	Unregistered = true;
...
var11_upvr.Slenderfish = {
	...
	Seasons = {"Winter"};
	Weather = {"Foggy"};
	Quips = {"WhÌ·aÌ´Í—ÍtÌ¸Í„Ì’?Ì¶Í‚Í›", "Oh! I collected his pages!", "Well, that's the end of him!", "SLENDERMAN???", "SLENDERFISH???"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Admin-Exclusive";
	Unregistered = true;
...
var11_upvr["Mutated Crystal Shrimp"] = {
...
var11_upvr["Crystal Frilled Shark"] = {
...
var11_upvr.Him = {
	...
	WeightPool = {1, 100000};
	Chance = 0;
	GlobalStrictChance = 0.00009999999999999999;
	StrictMaximumChance = 0.00009999999999999999;
	Rarity = "Secret";
	Resilience = -100;
	ForcedProgressEfficiency = 1;
...
var11_upvr["ðŸ‹"] = {
	...
	WeightPool = {1, 100000};
	GlobalStrictChance = 0.00019999999999999998;
	Chance = 0;
	Rarity = "Secret";
	Resilience = -100;
	ForcedProgressEfficiency = 2;
...
var11_upvr["ðŸŸ"] = {
	...
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"ðŸŸ", "ðŸ˜¡", "ðŸš½", "ðŸª¦", "ðŸ¤–", "ðŸ—£ï¸", "ðŸŽ£", "ðŸ ", "ðŸ¥¶", "ðŸ‘…", "ðŸ‘‘", "ðŸ’€", "ðŸ™", "ðŸ•Šï¸", "ðŸ†™", "â‰ï¸", "ðŸ¤“", "ðŸ”¥", "ðŸ˜­", "ðŸ˜œ", "ðŸ¤”", "â˜”", "ðŸ’°", "ðŸ§ ", "ðŸŽ‰", "ðŸ˜¤", "ðŸ¤¢", "ðŸ’©", "ðŸ˜ˆ", "ðŸ«¦", "ðŸŒŠ", "shhhh ðŸ¤«", "mane i dont want this ðŸ˜¢"};
	SparkleColor = Color3.fromRGB(64, 163, 255);
	HoldAnimation = fish:WaitForChild("basic");
	From = "None";
	Appraisable = false;
...
var11_upvr["Islandhopper Butterflyfish"] = {
...
var11_upvr["Stoplight Parrotfish"] = {
...
var11_upvr["Clowned Triggerfish"] = {
...
var11_upvr["Flamekissed Hawkfish"] = {
...
var11_upvr["Mirage Toadfish"] = {
	...
	Resilience = 10;
	ProgressEfficiency = 0.3;
	Description = "A ghostly fish shimmering in the oceanâ€™s depths.";
	Hint = "Lurks in waters favored by pirates.";
	FavouriteBait = "Squid";
	FavouriteTime = "Night";
	Price = 3523;
...
var11_upvr["Scalloped Hammerhead"] = {
...
var11_upvr["Great Goldcursed Shark"] = {
...
var11_upvr["Sloane's Viperfish"] = {
	...
	Seasons = {"Winter"};
	Weather = {"Windy"};
	Quips = {"Sloaneâ€™s Viperfish!", "Fangs in the void!", "Lantern lure!"};
	SparkleColor = Color3.fromRGB(0, 200, 255);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Cultist Lair";
}
var11_upvr["Spiny Hatchetfish"] = {
...
var11_upvr.Leviathan = {
	...
	ClientFishingPassives = {
		LeviathanBehavior = {
			...
			MinimumProgress = 50;
			ProgressLossRatio = 0.35;
			BarSizeReduction = 0.6;
			SizeReduceDuration = 5;
			AccelMultiply = 0.4;
			AccelMultiplyDuration = 6;
			Color = Color3.fromRGB(253, 255, 153);
		};
	};
}
var11_upvr["Profane Leviathan"] = {
	...
	ClientFishingPassives = {
		LeviathanBehavior = {
			...
			BaseChance = 20;
			MinimumProgress = 30;
			ProgressLossRatio = 0.5;
			BarSizeReduction = 0.7;
			SizeReduceDuration = 5;
			AccelMultiply = 0.3;
			AccelMultiplyDuration = 6;
			Color = Color3.fromRGB(62, 31, 31);
		};
	};
}
var11_upvr["Key of Oaths"] = {
...
var11_upvr.Frostwyrm = {
	...
	Description = "The Frostwyrm is a colossal, dragon-long leviathan that coils through frozen seas, its scales etched with ancient ice. Each surge of its body brings biting cold and unstoppable force, as if the ocean itself bends to its frostbound will.";
	Hint = "???";
	FavouriteBait = {"Sapphire Krill", "Frostnova Bait"};
	FavouriteTime = "Night";
	Price = 55000;
	XP = 25000;
	Seasons = {"Winter"};
	Weather = {"Rain"};
	Quips = {"A FROSTWYRM!?!?!", "COOL AS ICE!", "I'M FREEZING!!!", "BRR!!!!", "MASSIVE!!!!"};
	SparkleColor = Color3.fromRGB(255, 244, 244);
	HoldAnimation = fish:WaitForChild("heavy");
	From = "Boreal Pines";
	BiteColor = Color3.fromRGB(115, 201, 255);
	ClientFishingPassives = {
		FrostwyrmBehavior = {
			Cooldown = 5;
			BaseChance = 16;
			FreezeDuration = 3;
			ProgressLoss = 2;
			ProgressLossRatio = 0.1;
			AccelMultiply = 0.25;
			Color = Color3.fromRGB(150, 220, 255);
		};
	};
}
var11_upvr["Antarctic Icefish"] = {
	Icon = "rbxassetid://121711728159258";
	WeightPool = {10, 40};
	Chance = 30;
	Rarity = "Rare";
	Resilience = 60;
	Description = "The Antarctic Icefish is a unique pale fish with transparent blood, lacking hemoglobin, adapted to the freezing waters around Antarctica.";
	Hint = "Found in deep salt-water near Antarctic regions.";
	FavouriteBait = "Bagel";
	FavouriteTime = nil;
	Price = 330;
	XP = 200;
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"An Icefish!", "I caught an Antarctic Icefish!", "Wow, transparent blood!", "It's an Icefish!"};
	SparkleColor = Color3.fromRGB(220, 240, 255);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Boreal Pines";
}
var11_upvr["Polar Cod"] = {
	Icon = "rbxassetid://81290572753436";
	WeightPool = {5, 25};
	Chance = 60;
	Rarity = "Uncommon";
	Resilience = 50;
	Description = "The Polar Cod is a small, abundant fish adapted to icy Arctic waters, often found under sea ice.";
	Hint = "Found in open salt-water near Arctic regions.";
	FavouriteBait = "Insect";
	FavouriteTime = nil;
	Price = 112;
	XP = 70;
	Seasons = {"Winter", "Spring"};
	Weather = {"None"};
	Quips = {"A Polar Cod!", "I caught a Polar Cod!", "Arctic catch!", "It's a Polar Cod!"};
	SparkleColor = Color3.fromRGB(200, 220, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Boreal Pines";
}
var11_upvr["Saffron Cod"] = {
	Icon = "rbxassetid://117769976114481";
	WeightPool = {15, 50};
	Chance = 50;
	Rarity = "Uncommon";
	Resilience = 50;
	Description = "The Saffron Cod is a coastal fish with a yellowish tint, found in shallow northern Pacific waters.";
	Hint = "Found in shallow salt-water near northern coasts.";
	FavouriteBait = "Shrimp";
	FavouriteTime = nil;
	Price = 112;
	XP = 70;
	Seasons = {"Autumn", "Winter"};
	Weather = {"None"};
	Quips = {"A Saffron Cod!", "I caught a Saffron Cod!", "Yellowish cod!", "It's a Saffron Cod!"};
	SparkleColor = Color3.fromRGB(255, 220, 150);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Boreal Pines";
}
var11_upvr["Greenland Halibut"] = {
	Icon = "rbxassetid://127076239757256";
	WeightPool = {200, 800};
	Chance = 20;
	Rarity = "Rare";
	Resilience = 30;
	Description = "The Greenland Halibut is a large flatfish with both eyes on one side, thriving in deep cold Arctic waters.";
	Hint = "Found in deep salt-water near Greenland.";
	FavouriteBait = "Worm";
	FavouriteTime = nil;
	Price = 322;
	XP = 190;
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"A Halibut!", "I caught a Greenland Halibut!", "Big flatfish!", "It's a Greenland Halibut!"};
	SparkleColor = Color3.fromRGB(150, 180, 200);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Boreal Pines";
}
var11_upvr["Snow Crab"] = {
	Icon = "rbxassetid://73938237937490";
	WeightPool = {50, 200};
	Chance = 60;
	Rarity = "Uncommon";
	Resilience = 60;
	Description = "The Snow Crab is a long-legged crustacean with sweet meat, inhabiting cold muddy bottoms in northern seas.";
	Hint = "Found on the sea floor in cold waters.";
	FavouriteBait = "None";
	FavouriteTime = nil;
	Price = 110;
	XP = 70;
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"A Snow Crab!", "I caught a Snow Crab!", "Crabby catch!", "It's a Snow Crab!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Boreal Pines";
}
var11_upvr["Lake Whitefish"] = {
	Icon = "rbxassetid://118956823851495";
	WeightPool = {30, 150};
	Chance = 50;
	Rarity = "Unusual";
	Resilience = 50;
	Description = "The Lake Whitefish is a silvery freshwater fish with a small head, common in cold northern lakes.";
	Hint = "Found in deep freshwater lakes.";
	FavouriteBait = "Insect";
	FavouriteTime = nil;
	Price = 225;
	XP = 140;
	Seasons = {"Autumn", "Winter"};
	Weather = {"Foggy"};
	Quips = {"A Whitefish!", "I caught a Lake Whitefish!", "Freshwater gem!", "It's a Lake Whitefish!"};
	SparkleColor = Color3.fromRGB(220, 220, 220);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Boreal Pines";
}
var11_upvr.Eelpout = {
	...
	Rarity = "Unusual";
	Resilience = 60;
	Description = "The Eelpout is an elongated, eel-like fish with a large head, dwelling on the bottom in cold marine waters.";
	Hint = "Found on the bottom in cold salt-water.";
	FavouriteBait = "Worm";
	FavouriteTime = "Night";
	Price = 220;
	XP = 130;
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"An Eelpout!", "I caught an Eelpout!", "Slippery one!", "It's an Eelpout!"};
	SparkleColor = Color3.fromRGB(150, 150, 100);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Boreal Pines";
}
var11_upvr["Fourhorn Sculpin"] = {
	Icon = "rbxassetid://124085309402179";
	WeightPool = {10, 60};
	Chance = 50;
	Rarity = "Uncommon";
	Resilience = 75;
	Description = "The Fourhorn Sculpin is a bottom-dwelling fish with distinctive bony horns on its head, found in Arctic coastal waters.";
	Hint = "Found on rocky bottoms in cold salt-water.";
	FavouriteBait = "Shrimp";
	FavouriteTime = nil;
	Price = 111;
	XP = 70;
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"A Sculpin!", "I caught a Fourhorn Sculpin!", "Horny head!", "It's a Fourhorn Sculpin!"};
	SparkleColor = Color3.fromRGB(180, 150, 120);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Boreal Pines";
}
var11_upvr["Green Sea Urchin"] = {
	Icon = "rbxassetid://103773496957183";
	WeightPool = {5, 30};
	Chance = 60;
	Rarity = "Common";
	Resilience = 130;
	Description = "The Green Sea Urchin is a spiny echinoderm with short spines, grazing on algae in cold northern seas.";
	Hint = "Found on rocky sea floors in cold waters.";
	FavouriteBait = "None";
	FavouriteTime = nil;
	Price = 54;
	XP = 30;
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"A Sea Urchin!", "I caught a Green Sea Urchin!", "Spiky ball!", "It's a Green Sea Urchin!"};
	SparkleColor = Color3.fromRGB(100, 200, 100);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Boreal Pines";
}
var11_upvr["King Crab"] = {
	Icon = "rbxassetid://138436527744243";
	WeightPool = {300, 1000};
	Chance = 15;
	Rarity = "Legendary";
	Resilience = 20;
	Description = "The King Crab is a massive crustacean with long spiny legs and rich meat, from deep cold northern waters.";
	Hint = "Found in deep cold sea floors.";
	FavouriteBait = "None";
	FavouriteTime = nil;
	Price = 3575;
	XP = 3260;
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"A King Crab!", "I caught a King Crab!", "Royal catch!", "It's a King Crab!"};
	SparkleColor = Color3.fromRGB(255, 100, 100);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Boreal Pines";
}
var11_upvr["Glacial Squid"] = {
	...
	Resilience = 5;
	ProgressEfficiency = 0.15;
	Description = "The Glacial Squid is a massive deep-sea creature with hooked tentacles, lurking in freezing abyssal waters.";
	Hint = "Found in the deepest caves.";
	FavouriteBait = "Fish Head";
	FavouriteTime = "Night";
	Price = 8562;
	XP = 5050;
	Seasons = {"Winter"};
	Weather = {"None"};
	Quips = {"A Glacial Squid!", "I caught a Glacial Squid!", "Monster from the deep!", "It's colossal!"};
	SparkleColor = Color3.fromRGB(100, 100, 255);
	HoldAnimation = fish:WaitForChild("basic");
	From = "Boreal Pines";
}
var11_upvr["Bloop Fish"] = {
	Icon = "rbxassetid://84676091673435";
	BlockPassiveCapture = true;
	WeightPool = {2000000, 5000000};
	Chance = 1;
...
var11_upvr["Pale Ghost Lumpfish"] = {
...
var11_upvr["Starbellied Wolf Fish"] = {
...
var11_upvr["Lurking Crescent Pike"] = {
...
var11_upvr["Crystallized Seadragon"] = {
	BlockPassiveCapture = true;
...
var11_upvr["Ashcloud Archerfish"] = {
	BlockPassiveCapture = true;
...
var11_upvr["Lovestorm Eel Supercharged"] = {
	BlockPassiveCapture = true;
...
var11_upvr["Grand Reef Guardian"] = {
	WeightPool = {400, 800};
	Chance = 0.008;
	Rarity = "Mythical";
	Resilience = 25;
...
var11_upvr["Hollow Flake Catfish"] = {
	WeightPool = {20, 50};
	Chance = 7;
	Rarity = "Limited";
	Resilience = 30;
...
var11_upvr["Green Energy Crystal"] = {
	WeightPool = {25, 50};
	Chance = 0.001;
	Rarity = "Mythical";
	Resilience = 100;
...
var11_upvr["Yellow Energy Crystal"] = {
	WeightPool = {25, 50};
	Chance = 0.001;
	Rarity = "Mythical";
	Resilience = 100;
...
var11_upvr["Blue Energy Crystal"] = {
	WeightPool = {25, 50};
	Chance = 0.001;
	Rarity = "Mythical";
	Resilience = 100;
...
var11_upvr["Frigid Mammoth Tusk"] = {
	WeightPool = {2500, 5000};
	Chance = 0.05;
	Rarity = "Mythical";
	Resilience = 15;
...
var11_upvr["Chillback Whitefish"] = {
	WeightPool = {25, 55};
	Chance = 55;
	Rarity = "Unusual";
	Resilience = 65;
...
var11_upvr["Ancient Megalodon"] = {
	...
	ClientFishingPassives = {
		MegalodonBehavior = {
			...
			Duration = 2;
			AnimTime = 0.5;
			Color = Color3.fromRGB(212, 51, 51);
		};
	};
}
var11_upvr["Forsaken Algae"] = {
	BlockPassiveCapture = true;
	WeightPool = {25, 50};
	Chance = 40;
	Rarity = "Limited";
...
var11_upvr["Ancient Serpent Spine"] = {
	WeightPool = {30, 80};
	Chance = 0.01;
	Rarity = "Limited";
	Resilience = 100;
...
var11_upvr["Ancient Serpent Skull"] = {
	WeightPool = {50, 100};
	Chance = 0.005;
	Rarity = "Limited";
	Resilience = 100;
...
var11_upvr.Boots = {
	...
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"Cool", "Found the other one!"};
	SparkleColor = Color3.fromRGB(170, 255, 255);
	HoldAnimation = fish:WaitForChild("small");
	From = "Ocean";
}
var11_upvr.RocketFuel = {
	WeightPool = {12, 13};
	Chance = 0.05;
	Rarity = "Exotic";
	Resilience = 100;
...
var11_upvr["Device Display"] = {
	...
	Resilience = 100;
	ProgressEfficiency = 0.65;
	Description = "Used to craft the Translator";
	Hint = "Dr. Crookspine knows what to do with this.";
	FavouriteBait = "Magnet";
	FavouriteTime = "None";
	Price = 250;
	XP = 180;
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"It's so bright!", "AH! It almost electrocuted me"};
	SparkleColor = Color3.fromRGB(176, 255, 164);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Ocean";
}
var11_upvr["Translator Core"] = {
	...
	Seasons = {"None"};
	Weather = {"None"};
	Quips = {"Uau!", "ãŠãŠï¼", "ìš°ì™€!", "\xA1Guau!", "å“‡ï¼", "Wauw!", "Gleeb!"};
	SparkleColor = Color3.fromRGB(176, 255, 164);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Roslit";
}
var11_upvr["Communication Circuit"] = {
...
var11_upvr["Deep-sea Hatchetfish"] = {
	WeightPool = {5, 35};
	Chance = 100;
	Rarity = "Common";
	Resilience = 90;
...
var11_upvr["Deep-sea Dragonfish"] = {
	WeightPool = {8, 40};
	Chance = 100;
	Rarity = "Common";
	Resilience = 80;
...
var11_upvr["Small Spine Chimera"] = {
	WeightPool = {800, 1500};
	Chance = 0.2;
	Rarity = "Legendary";
	Resilience = 10;
	ProgressEfficiency = 0.9;
	Description = "A large, intimidating fish with spiny fins, sharp teeth, and a menacing, serpent-like body. The Chimera uses its pickaxe-like bill to strike targets, knocking them out or possibly penetrating them entirely in two pieces.";
...
var11_upvr["Barreleye Fish"] = {
	WeightPool = {50, 150};
	Chance = 0.01;
	Rarity = "Mythical";
	Resilience = 20;
	ProgressEfficiency = 0.85;
	Description = "A transparent fish with a dome-shaped head and large, upward-facing eyes, adapted for deep waters with its 3 eyes. The third eye has a similar effect that night-vision goggles have, giving it full 20/20 vision, even in the darkest of waters.";
...
var11_upvr["Ancient Depth Serpent"] = {
...
var11_upvr["Shortfin Mako Shark"] = {
	WeightPool = {250, 1000};
	Chance = 100;
	Rarity = "Common";
	Resilience = 80;
...
var11_upvr["Buccaneer Barracuda"] = {
	WeightPool = {90, 250};
	Chance = 60;
	Rarity = "Uncommon";
	Resilience = 50;
	...
	Hint = "Lurks near reefs during the during cold nights.";
	FavouriteBait = "Deep Coral";
	FavouriteTime = "Night";
	Price = 112;
	XP = 70;
...
var11_upvr["Shipwreck Barracuda"] = {
	WeightPool = {100, 300};
	Chance = 0.1;
	Rarity = "Legendary";
	Resilience = 10;
...
var11_upvr["Pirate Captain's Goldfish"] = {
	BlockPassiveCapture = true;
	...
	Rarity = "Secret";
	Resilience = 1;
	Description = "A mythical, elusive goldfish found beneath waterfalls, said to bring immense fortune to rare finders.";
	Hint = "???";
	FavouriteBait = "Truffle Worm";
	FavouriteTime = "Day";
	Price = 30094;
	...
	Seasons = {"Summer"};
	Weather = {"None"};
	Quips = {"IS THAT A PIRATE CAPTAIN'S GOLDFISH?!", "IS THAT NICHOLAS ANIMEPUNK?!"};
...
var11_upvr.Boot = {
	...
	Rarity = "Trash";
	Resilience = 120;
	Description = "Who would leave this in an ocean? Seems to be in great condition too. A common boot, must have fallen off of a boat?.. Or someone must have fallen off of a boat.. Whatever. either way, it's yours now!";
	Hint = "Find it in cheap bodies of water.";
	FavouriteBait = "Magnet";
	FavouriteTime = nil;
	Price = 15;
...
var11_upvr["Bloop Cosmetic Crate"] = {
...
var11_upvr["Enchant Relic"] = {
	WeightPool = {210, 210};
	Chance = 0.2;
	GlobalStrictChance = 0.2857142857142857;
	Rarity = "Relic";
	Resilience = 35;
	ProgressEfficiency = 0.8;
...
var11_upvr.Gazerfish = {
	WeightPool = {80, 140};
	Chance = 100 * tbl_2["Brine Pool"].Common;
	Rarity = "Common";
	Resilience = 85;
...
var11_upvr["Brine Shrimp"] = {
	WeightPool = {1, 3};
	Chance = 90 * tbl_2["Brine Pool"].Uncommon;
	Rarity = "Uncommon";
	Resilience = 65;
...
var11_upvr["Globe Jellyfish"] = {
	WeightPool = {140, 240};
	Chance = 60 * tbl_2["Brine Pool"].Unusual;
	Rarity = "Unusual";
	Resilience = 25;
...
var11_upvr["Dweller Catfish"] = {
	WeightPool = {100, 160};
	Chance = 40 * tbl_2["Brine Pool"].Rare;
	Rarity = "Rare";
	Resilience = 20;
	ProgressEfficiency = 0.8;
...
var11_upvr["Spectral Serpent"] = {
	WeightPool = {110000, 130000};
	Chance = 0.02;
	FinalChanceDivisor = 15;
	Rarity = "Mythical";
	Resilience = 10;
	ProgressEfficiency = 0.2;
...
var11_upvr["Coral Geode"] = {
	WeightPool = {180, 180};
	Chance = 17 * tbl_2["Desolate Deep"].Uncommon;
	Rarity = "Unusual";
	Resilience = 120;
...
var11_upvr["Slate Tuna"] = {
	WeightPool = {300, 600};
	Chance = 90 * tbl_2["Desolate Deep"].Common;
	Rarity = "Common";
	Resilience = 35;
...
var11_upvr["Phantom Ray"] = {
	WeightPool = {40, 60};
	Chance = 90 * tbl_2["Desolate Deep"].Uncommon;
	Rarity = "Uncommon";
	Resilience = 45;
...
var11_upvr["Rockstar Hermit Crab"] = {
	WeightPool = {4, 12};
	Chance = 25 * tbl_2["Desolate Deep"].Unusual;
	Rarity = "Unusual";
	Resilience = 100;
...
var11_upvr["Cockatoo Squid"] = {
	WeightPool = {4, 20};
	Chance = 45 * tbl_2["Desolate Deep"].Unusual;
	Rarity = "Unusual";
	Resilience = 35;
...
var11_upvr.Banditfish = {
	WeightPool = {150, 200};
	Chance = 75 * tbl_2["Desolate Deep"].Rare;
	Rarity = "Rare";
	Resilience = 30;
...
var11_upvr.Anchovy = {
	...
	Hint = "Caught in the saltwaters of Moosewood";
	FavouriteBait = "None";
	FavouriteTime = "Day";
	Price = 50;
	XP = 30;
...
var11_upvr.Pike = {
	...
	Hint = "Found in Moosewood's freshwater. Seems to prefer insect baits. Very vicious.";
	FavouriteBait = "Insect";
	FavouriteTime = nil;
	Price = 222;
	XP = 130;
...
var11_upvr.Oyster = {
	...
	Rarity = "Uncommon";
	Resilience = 95;
	Description = "Oysters are bivalve molluscs with rough, irregularly shaped shells. They are typically found in clusters, attached to submerged rocks and roots. They can be found all over Terrapin Island; The Oysters help filter the water of Terrapin, leaving making it nearly a freshwater island.";
...
var11_upvr["Scalloped Spiny Lobster"] = {
	WeightPool = {45, 120};
	Chance = 30;
	Rarity = "Extinct";
	Resilience = 40;
...
var11_upvr["Spiny Sunstone Lobster"] = {
	WeightPool = {45, 170};
	Chance = 85;
	Rarity = "Extinct";
	Resilience = 85;
...
var11_upvr["Western Rock Lobster"] = {
	WeightPool = {19, 50};
	Chance = 90;
	Rarity = "Extinct";
	Resilience = 90;
...
var11_upvr["Azureback Haddock School"] = {
	WeightPool = {180, 750};
	Chance = 80;
	Rarity = "Extinct";
	Resilience = 85;
...
var11_upvr["Bluefin Tuna School"] = {
	WeightPool = {125, 400};
	Chance = 90;
	Rarity = "Extinct";
	Resilience = 95;
...
var11_upvr["Coralwing Guppy School"] = {
	WeightPool = {180, 580};
	Chance = 30;
	Rarity = "Extinct";
	Resilience = 35;
...
var11_upvr["Duskwave Herring School"] = {
	WeightPool = {230, 620};
	Chance = 10;
	Rarity = "Extinct";
	Resilience = 40;
...
var11_upvr["Infernal Halibut School"] = {
	WeightPool = {250, 670};
	Chance = 5;
	Rarity = "Extinct";
	Resilience = 20;
...
var11_upvr["Moonveil Salmon School"] = {
	WeightPool = {235, 615};
	Chance = 45;
	Rarity = "Extinct";
	Resilience = 60;
...
var11_upvr["Seaspawn Shrimp School"] = {
	WeightPool = {350, 1500};
	Chance = 1;
	Rarity = "Extinct";
	Resilience = 1;
...
var11_upvr["Shiver Swarmfish School"] = {
	WeightPool = {200, 600};
	Chance = 45;
	Rarity = "Extinct";
	Resilience = 60;
...
var11_upvr["Veinfin Tetra School"] = {
	WeightPool = {220, 660};
	Chance = 80;
	Rarity = "Extinct";
	Resilience = 85;
...
var11_upvr["Great Hammerhead Shark"] = {
...
var11_upvr.Perch = {
	...
	Hint = "Found in the freshwaters of Roslit.";
	FavouriteBait = "Worm";
	FavouriteTime = nil;
	Price = 54;
	XP = 30;
...
var11_upvr["Suckermouth Catfish"] = {
	WeightPool = {95, 170};
	Chance = 35;
	Rarity = "Rare";
	Resilience = 60;
...
var11_upvr["Magma Tang"] = {
	...
	Seasons = {"Spring", "Summer"};
	Weather = {"None"};
	Quips = {"Ouu a Magma Tang!", "Woah, a Magma Tang!", "A Magma Tang!", "I caught a Magma Tang!", "I caught a Magma Tang!", "Found her!.. But evil!"};
	SparkleColor = Color3.fromRGB(255, 158, 73);
	HoldAnimation = fish:WaitForChild("tiny");
	From = "Roslit Volcano";
}
var11_upvr["Ember Snapper"] = {
	WeightPool = {60, 120};
	Chance = 50;
	Rarity = "Unusual";
	Resilience = 40;
...
var11_upvr.Bluegill = {
	...
	Hint = "Found in saltwater near Snowcap.";
	FavouriteBait = "Insect";
	FavouriteTime = nil;
	Price = 51;
	XP = 30;
...
var11_upvr["Glacier Pike"] = {
	...
	Hint = "Found in Snowcap's freshwater. Seems to prefer insect baits.";
	FavouriteBait = "Insect";
	FavouriteTime = nil;
	Price = 222;
	XP = 130;
...
var11_upvr.Wiifish = {
	...
	Resilience = 40;
	ProgressEfficiency = 0.8;
	Description = "The Wiifish is a legendary tropic fish that can only be found in the saltwaters of Sunstone Island during the day. They are an extremely old fish, dating back over 230,000,000 years ago. While the Wiifish is a slow swimmer, they can put up an immense fight for even advanced anglers.";
...
var11_upvr["Radiant Crystal"] = {
	...
	ClientFishingPassives = {
		RadiantCrystalBehavior = {
			BaseShrinkSpeed = 0.015;
			OffBarMultiplier = 2.5;
		};
	};
}
var11_upvr["Smallmouth Bass"] = {
	WeightPool = {5, 17};
	Chance = 75;
	Rarity = "Common";
	Resilience = 80;
...
var11_upvr["Golden Smallmouth Bass"] = {
	WeightPool = {15, 45};
	Chance = 4;
	Rarity = "Legendary";
	Resilience = 55;
...
var11_upvr.Isonade = {
	...
	Resilience = 8;
	ProgressEfficiency = 0.5;
	Description = "The Isonade is a sinister creature that is assumed extinct. They are seeming to be a dream that is possible to be caught and captured. They only circle near Strange Whirlpools, and sometimes can even be the cause for one.";
...
var11_upvr["Pumpkin Pufferfish"] = {
	...
	Seasons = {"Autumn"};
	Weather = {"None"};
	Quips = {"ðŸŽƒ", "The Jack-o-Lantern muhaahaha", "The chocolate Icing MUHAHAHAH", "The SPOOKY version of the pufferfish."};
	SparkleColor = Color3.fromRGB(255, 227, 15);
	HoldAnimation = fish:WaitForChild("small");
	AnnounceInChat = true;
	FromLimited = "FischFright 2";
...
var11_upvr["Mourning Manta Ray"] = {
	...
	Seasons = {"Autumn"};
	Weather = {"Windy"};
	Quips = {"Awe poor Manta Ray :(.", "Rip Skelefish 24 - 24.", "LLSF ðŸ•Šï¸ðŸ•Šï¸ðŸ•Šï¸."};
	SparkleColor = Color3.fromRGB(87, 118, 255);
	HoldAnimation = fish:WaitForChild("heavy");
	FromLimited = "FischFright 2";
	From = "FischFright 2";
...
var11_upvr["Xtra Sour Gummy Pack"] = {
	WeightPool = {8, 8};
	Chance = 0;
	Rarity = "Limited";
	Resilience = 130;
...
var11_upvr["Gravestone Stingray"] = {
...
var11_upvr["Marshmallow Mackerel"] = {
	WeightPool = {50, 200};
	Chance = 50;
	Rarity = "Limited";
	Resilience = 50;
...
var11_upvr["Peppermint Pike"] = {
	WeightPool = {11, 22};
	Chance = 80;
	Rarity = "Limited";
	Resilience = 85;
	ProgressEfficiency = 1.05;
	Description = "A feisty pike striped like peppermint candy. Bites with a minty fresh snap!";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 52;
	XP = 30;
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Peppermint Pike!", "How does it taste?", "So minty!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr.Stockingfish = {
	WeightPool = {10, 20};
	Chance = 40;
	Rarity = "Limited";
	Resilience = 55;
	ProgressEfficiency = 0.9;
	Description = "Wiggly stocking-shaped fish stuffed with holiday cheer (or maybe just coal).";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 342;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Stockingfish!", "Christmas came early!", "What presents are hiding in it?"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Wreath Wrasse"] = {
	WeightPool = {22, 44};
	Chance = 75;
	Rarity = "Limited";
	Resilience = 82;
	Description = "It seems to be so full of joy and festivities, that it's wearing a wreath!";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 52;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Wreath Wrasse!", "Festive!", "This would go on my front door!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Holly Haddock"] = {
	WeightPool = {18, 36};
	Chance = 65;
	Rarity = "Limited";
	Resilience = 75;
	Description = "Haddock decked out in holly leaves. Prickly but jolly on the holidays.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 106;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Holly Haddock!", "Festive and flaky!", "Holly jolly fish!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Tinsel Trout"] = {
	WeightPool = {14, 25};
	Chance = 60;
	Rarity = "Limited";
	Resilience = 72;
	ProgressEfficiency = 1.05;
	Description = "Shiny trout tangled in tinsel. Sparkles more than your tree topper.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 107;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Tinsel Trout!", "All wrapped up!", "Shiny and swimmy!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Candy Cane Cod"] = {
	WeightPool = {9, 21};
	Chance = 45;
	Rarity = "Limited";
	Resilience = 65;
	Description = "Cod curved like a candy cane. Sweet on the outside, fishy within.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 217;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Candy Cane Cod!", "Twisted treat!", "Sugar rush swimmer!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Candy Cane"] = {
	WeightPool = {8, 18};
	Chance = 35;
	Rarity = "Limited";
	Resilience = 100;
	ProgressEfficiency = 1.2;
	Description = "A giant candy cane that swam away from the tree. Sticky hook trouble.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 300;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Candy Cane!", "Not for eating... yet!", "Sweet snag!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Hot Cocoa"] = {
	WeightPool = {7, 17};
	Chance = 32;
	Rarity = "Limited";
	Resilience = 100;
	ProgressEfficiency = 1.15;
	Description = "Steaming mug of hot cocoa with marshmallow fins. Warms your hands while reeling.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 300;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"Hot Cocoa!", "Toasty treat!", "Don't spill it!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Gingerbread Man"] = {
	WeightPool = {8, 19};
	Chance = 34;
	Rarity = "Limited";
	Resilience = 100;
	ProgressEfficiency = 1.1;
	Description = "Gingerbread man cookie that grew fins. Runs away... by swimming.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 300;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Gingerbread Man!", "Catch me if you can!", "Crumbs in the water!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Glass of Eggnog"] = {
	WeightPool = {9, 20};
	Chance = 33;
	Rarity = "Limited";
	Resilience = 53;
	ProgressEfficiency = 0.93;
	Description = "A nice glass of eggnog! Could go well with a gingerbread cookie?";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 341;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"Glass of Eggnog!", "Cheers to fish!", "Creamy catch!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr.Snowball = {
	...
	Resilience = 48;
	ProgressEfficiency = 0.9;
	Description = "Perfect snowball that rolls underwater. Packs a chilly punch.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 347;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Snowball!", "Snow way!", "Chill pill!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Ornament Pufferfish"] = {
	WeightPool = {10, 22};
	Chance = 36;
	Rarity = "Limited";
	Resilience = 54;
	ProgressEfficiency = 0.94;
	Description = "Pufferfish puffed up like a shiny ornament. Pops with holiday bling.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 339;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"An Ornament Pufferfish!", "Bauble buddy!", "Inflated decor!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Mistletoe Minnow"] = {
	WeightPool = {11, 21};
	Chance = 48;
	Rarity = "Limited";
	Resilience = 68;
	ProgressEfficiency = 1.12;
	Description = "Tiny minnow with mistletoe on its head. Kisses your bait goodbye.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 216;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Mistletoe Minnow!", "Pucker up!", "Holiday smooch!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Carol Carp"] = {
	WeightPool = {12, 23};
	Chance = 42;
	Rarity = "Limited";
	Resilience = 62;
	ProgressEfficiency = 0.97;
	Description = "Carp that hums carols underwater. Sings while it swims away.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 221;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Carol Carp!", "Fa la la fish!", "Tune-y carp!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Reindeer Ray"] = {
	WeightPool = {35, 68};
	Chance = 28;
	Rarity = "Limited";
	Resilience = 49;
	ProgressEfficiency = 0.89;
	Description = "Ray with antlers and red nose. Pulls Santa's sleigh... underwater?";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 347;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Reindeer Ray!", "Rudolph's cousin!", "Antlered floater!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("heavy");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Elf Eel"] = {
	...
	Description = "Slippery elf eel in pointy hat. Makes toys while tying your line in knots.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 349;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"An Elf Eel!", "Workshop wriggler!", "Pointy and pesky!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Nutcracker Catfish"] = {
	WeightPool = {16, 29};
	Chance = 31;
	Rarity = "Limited";
	Resilience = 50;
	ProgressEfficiency = 0.91;
	Description = "Catfish dressed as nutcracker. Cracks nuts and your patience.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 345;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Nutcracker Catfish!", "Crack that shell!", "Marching menace!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Fruitcake Flounder"] = {
	WeightPool = {17, 30};
	Chance = 27;
	Rarity = "Limited";
	Resilience = 46;
	ProgressEfficiency = 0.87;
	Description = "Dense flounder made of fruitcake. Sinks like a brick, tastes like regret.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 351;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Fruitcake Flounder!", "Heavy holiday hassle!", "Fruit-fish fail!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Bauble Bass"] = {
	WeightPool = {13, 25};
	Chance = 32;
	Rarity = "Limited";
	Resilience = 49;
	ProgressEfficiency = 0.97;
	Description = "Bass shaped like a dangling bauble. Rolls around, shiny and dizzy.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 341;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Bauble Bass!", "Hangin' around!", "Ornamental oddball!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr.Bellfin = {
	...
	Resilience = 48;
	ProgressEfficiency = 1.07;
	Description = "Fish with jingly bell fins. Rings every time it flops in panic.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 339;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Bellfin!", "Jingle all the way!", "Ding dong dash!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("tiny");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
...
var11_upvr["Jolly Bait Crate"] = {
	WeightPool = {80, 80};
	Chance = 5;
	Rarity = "Limited";
	Resilience = 70;
	ProgressEfficiency = 0.95;
	Description = "Crate of jolly bait that swims. Bait that catches itself? Cheater!";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = "Magnet";
	FavouriteTime = nil;
	BuyMult = 2.3;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Jolly Bait Crate!", "I'm feeling JOLLY!", "I wonder what could be inside!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
	...
	IsCrate = true;
	CrateType = "Bait";
	BaitContents = {"Cookie Crumble", "Fruitcake Flakes"};
}
var11_upvr.Present = {
	WeightPool = {70, 70};
	Chance = 10;
	...
	Resilience = 66;
	ProgressEfficiency = 0.9;
	Description = "Gift-wrapped present bobbing along. Shake it to hear the mystery rattle.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = "Magnet";
	FavouriteTime = nil;
	Price = 222;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Present!", "What's inside?", "Unwrap later!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	AnnounceInChat = true;
	FromLimited = "Fischmas 2";
	...
	Currency = "Bells";
	BaitContents = {"Cookie Crumble", "Fruitcake Flakes"};
	FishContents = module.Normal;
	CoinContents = {5, 15};
}
var11_upvr["Snowy Present"] = {
	WeightPool = {80, 80};
	Chance = 6;
	Rarity = "Limited";
	Resilience = 45;
	ProgressEfficiency = 0.85;
	Description = "Present dusted in snow. Cold shoulder to your hook, but full of surprises.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = "Magnet";
	FavouriteTime = nil;
	Price = 353;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Snowy Present!", "Frosty gift!", "Chilled cheer!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	AnnounceInChat = true;
	FromLimited = "Fischmas 2";
	...
	Currency = "Bells";
	BaitContents = {"Cookie Crumble", "Fruitcake Flakes"};
	FishContents = module.Snowy;
	CoinContents = {15, 30};
}
var11_upvr["Santa's Present"] = {
	WeightPool = {100, 100};
	Chance = 1;
	FinalChanceDivisor = 10;
	Rarity = "Limited";
	Resilience = 35;
	ProgressEfficiency = 0.7;
	Description = "The big man's personal present. Naughty or nice? It's judging you!";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = "Magnet";
	FavouriteTime = nil;
	Price = 12414;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"Santa's Present!", "Ho ho holy cow!", "Ultimate gift!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	AnnounceInChat = true;
	FromLimited = "Fischmas 2";
	...
	Currency = "Bells";
	BaitContents = {"Cookie Crumble", "Fruitcake Flakes"};
	FishContents = module.Santa;
	CoinContents = {25, 75};
}
var11_upvr["Merry Manta Ray"] = {
	WeightPool = {25, 40};
	Chance = 7;
	Rarity = "Limited";
	Resilience = 32;
	ProgressEfficiency = 0.65;
	Description = "Manta ray in a Santa hat, gliding merrily. Spreads joy and wingspans.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 1893;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Merry Manta Ray!", "Winged wonder!", "Holiday hover!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("heavy");
	AnnounceInChat = true;
	FromLimited = "Fischmas 2";
...
var11_upvr["Santa Whale Shark"] = {
	WeightPool = {30, 50};
	Chance = 3;
	Rarity = "Limited";
	Resilience = 25;
	ProgressEfficiency = 0.2;
	Description = "Whale shark in full Santa suit. Delivers gifts... and tidal waves.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 3495;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Santa Whale Shark!", "Jolly giant!", "Ho ho huge!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("heavy");
	AnnounceInChat = true;
	FromLimited = "Fischmas 2";
...
var11_upvr["Northstar Whale"] = {
	...
	Resilience = 20;
	ProgressEfficiency = 0.1;
	Description = "Majestic whale glowing like the North Star. Guides lost fish home... or your boat.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 35000;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Northstar Whale!", "Starry behemoth!", "Cosmic catch!"};
	SparkleColor = Color3.fromRGB(255, 241, 160);
	HoldAnimation = fish:WaitForChild("heavy");
	AnnounceInChat = true;
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
	...
	ClientFishingPassives = {
		MegalodonBehavior = {
			...
			Duration = 2;
			AnimTime = 0.5;
			Color = Color3.fromRGB(251, 255, 184);
		};
	};
}
var11_upvr["Festive Relic"] = {
	WeightPool = {210, 210};
	Chance = 1;
	FinalChanceDivisor = 100;
	PassiveChanceDivisor = 100;
	BlockPassiveCapture = true;
	Rarity = "Limited";
	Resilience = 120;
	ProgressEfficiency = 0.8;
	Description = "Ancient relic pulsing with festive magic. Older than Santa, twice as mysterious.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 25000;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A Festive Relic!", "Timeless treasure!", "Holiday heirloom!"};
	SparkleColor = Color3.fromRGB(255, 255, 255);
	HoldAnimation = fish:WaitForChild("basic");
	AnnounceInChat = true;
	FromLimited = "Fischmas 2";
...
var11_upvr["Cryoshock Serpent"] = {
	WeightPool = {50000, 80000};
	Chance = 1;
	MaximumLifetimeCatches = 1;
	FinalChanceDivisor = 5;
	BlockPassiveCapture = true;
	PassiveChanceDivisor = math.huge;
	Rarity = "Limited";
	Resilience = 20;
	ForcedProgressEfficiency = 0.1;
	Description = "The Cryoshock Serpent is a volatile, frost-ridden evolution of the Northstar, pulsing with icy electricity. Imprisoned beneath ancient ice shelves, its very presence chills the sea and shatters the courage of even elite anglers.";
	Hint = "Only can be caught during Fischmas25.";
	FavouriteBait = nil;
	FavouriteTime = nil;
	Price = 63500;
	...
	Seasons = {"Winter"};
	Weather = {"Clear"};
	Quips = {"A CRYOSHOCK SERPENT!", "ITS FREEZING!", "I'M SO COLD!"};
	SparkleColor = Color3.fromRGB(157, 234, 255);
	HoldAnimation = fish:WaitForChild("heavy");
	AnnounceInChat = true;
	FromLimited = "Fischmas 2";
	From = "Fischmas 2";
	...
	ClientFishingPassives = {
		LeviathanBehavior = {
			...
			AccelMultiply = 0.4;
			AccelMultiplyDuration = 6;
			Color = Color3.fromRGB(156, 253, 255);
		};
	};
}
var11_upvr["Confetti Shark"] = {
	WeightPool = {800, 1200};
	Chance = 50;
	Rarity = "Limited";
	Resilience = 50;
...
var11_upvr["Frostscale Fangtooth"] = {
	WeightPool = {30, 70};
	Chance = 60;
	Rarity = "Common";
	Resilience = 90;
...
var11_upvr["Deep Freeze Devilfish"] = {
	WeightPool = {90, 190};
	Chance = 20;
	Rarity = "Unusual";
	Resilience = 65;
...
var11_upvr["Stormcloud Angelfish"] = {
	WeightPool = {600, 1200};
	Chance = 25;
	Rarity = "Rare";
	Resilience = 30;
...
var11_upvr["Atlantean Alchemist"] = {
	WeightPool = {200, 400};
	Chance = 10;
	Rarity = "Rare";
	Resilience = 25;
...
var11_upvr["Chronos Deep Swimmer"] = {
	WeightPool = {55, 100};
	Chance = 22;
	Rarity = "Unusual";
	Resilience = 38;
...
var11_upvr["Titanic Black Seadevil"] = {
	WeightPool = {55, 105};
	Chance = 80;
	Rarity = "Common";
	Resilience = 95;
...
var11_upvr["Leviathan Humpback Anglerfish"] = {
	WeightPool = {350, 800};
	Chance = 70;
	Rarity = "Common";
	Resilience = 90;
...
var11_upvr["Abyssal Bearded Seadevil"] = {
...
var11_upvr["Colossal Saccopharynx"] = {
	WeightPool = {800, 2000};
	Chance = 55;
	Rarity = "Uncommon";
	Resilience = 70;
...
var11_upvr["Radiant Triplewart Seadevil"] = {
	WeightPool = {100, 210};
	Chance = 35;
	Rarity = "Unusual";
	Resilience = 55;
...
var11_upvr["Deeplight Footballfish"] = {
	WeightPool = {175, 400};
	Chance = 20;
	Rarity = "Rare";
	Resilience = 65;
...
var11_upvr["Infant Giant Seadevil"] = {
	WeightPool = {6000, 17000};
	Chance = 0.005;
	Rarity = "Legendary";
	Resilience = 12;
...
var11_upvr["Quartzfin Queenfish"] = {
	WeightPool = {180, 400};
	Chance = 65;
	Rarity = "Common";
	Resilience = 100;
...
var11_upvr["Emerald Elephantnose"] = {
	WeightPool = {600, 1600};
	Chance = 45;
	Rarity = "Uncommon";
	Resilience = 90;
...
var11_upvr["Prismatic Parrotfish"] = {
	WeightPool = {80, 240};
	Chance = 10;
	Rarity = "Rare";
	Resilience = 40;
...
var11_upvr["Shimmering Silverside"] = {
	WeightPool = {250, 700};
	Chance = 3;
	Rarity = "Mythical";
	Resilience = 20;
...
var11_upvr["Infernal Iguanafish"] = {
...
var11_upvr["Smoldering Stingray"] = {
	WeightPool = {80, 170};
	Chance = 35;
	Rarity = "Unusual";
	Resilience = 75;
...
var11_upvr["Serpent Surgeonfish"] = {
	WeightPool = {850, 2100};
	Chance = 55;
	Rarity = "Uncommon";
	Resilience = 75;
...
var11_upvr["Cyclone Scorpionfish"] = {
	WeightPool = {460, 1200};
	Chance = 20;
	Rarity = "Rare";
	Resilience = 40;
...
var11_upvr["Twilight Tentaclefish"] = {
...
var11_upvr["Parktail Spinesnapper"] = {
...
var11_upvr["Dreaming Aberration"] = {
...
var11_upvr["Abyssborn Monstrosity"] = {
...
var11_upvr["Velvet Belly Lanternshark"] = {
...
var11_upvr["Sarcastic Fringehead"] = {
...
var11_upvr["Psychedelic Frogfish"] = {
...
var11_upvr["Tropical Bait Crate"] = {
...
var11_upvr["Jurassic Mosasaurus"] = {
...
var11_upvr["Jurassic Helicoprion"] = {
	WeightPool = {2000, 8000};
	Chance = 40;
	ProgressEfficiency = 0.4;
	Rarity = "Limited";
...
var11_upvr["Crowned Royal Gramma"] = {
	WeightPool = {90, 300};
	Chance = 90;
	Rarity = "Common";
	Resilience = 100;
...
var11_upvr["Gemscale Mandarinfish"] = {
	WeightPool = {40, 110};
	Chance = 70;
	Rarity = "Uncommon";
	Resilience = 85;
...
var11_upvr["Goldband Butterflyfish"] = {
	WeightPool = {70, 220};
	Chance = 65;
	Rarity = "Uncommon";
	Resilience = 85;
...
var11_upvr["Gemstone Whale Shark"] = {
